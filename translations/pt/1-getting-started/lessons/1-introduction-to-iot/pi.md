...
1. No Raspberry Pi Imager, selecione o botão **CHOOSE OS**, depois escolha *Raspberry Pi OS (Other)* e, em seguida, *Raspberry Pi OS Lite (32-bit)*.
    ...
    ![O Raspberry Pi Imager com o Raspberry Pi OS Lite selecionado](../../../../../translated_images/pt/raspberry-pi-imager.24aedeab9e233d84.png)
...
1. Abre esta pasta no VS Code selecionando *File -> Open...* e escolhendo a pasta *nightlight*, depois seleciona **OK**.
    ...
    ![A janela de diálogo do VS Code a mostrar a pasta nightlight](../../../../../translated_images/pt/vscode-open-nightlight-remote.d3d2a4011e30d535.png)
