...
![Wio Terminal üzerindeki mikrofon](../../../../../translated_images/wio-mic.3f8c843dbe8ad917.tr.png)
...
![ReSpeaker 2-Mics Pi Hat](../../../../../translated_images/respeaker.f5d19d1c6b14ab16.tr.png)
...
1. Wio Terminal kapalıyken, ReSpeaker 2-Mics Pi Hat'i jumper kabloları ve Wio Terminal'in arkasındaki GPIO soketlerini kullanarak Wio Terminal'e bağlayın:
    ...
    ![Bir pin diyagramı](../../../../../translated_images/wio-respeaker-wiring-0.767f80aa65081038.tr.png)
...
1. GPIO soketlerinin sol tarafında bu işlemi aşağıya kadar tekrarlayın. Pinlerin sıkıca oturduğundan emin olun.
    ...
    ![ReSpeaker'ın sol tarafındaki pinlerin Wio Terminal'in sol tarafındaki pinlere bağlanmış hali](../../../../../translated_images/wio-respeaker-wiring-1.8d894727f2ba2400.tr.png)

    ![ReSpeaker'ın sol tarafındaki pinlerin Wio Terminal'in sol tarafındaki pinlere bağlanmış hali](../../../../../translated_images/wio-respeaker-wiring-2.329e1cbd306e754f.tr.png)
...
1. Aynı işlemi ReSpeaker ve Wio Terminal'in sağ tarafındaki GPIO soketleri için tekrarlayın. Bu kablolar, zaten bağlı olan kabloların etrafından geçmelidir.
    ...
    ![ReSpeaker'ın sağ tarafındaki pinlerin Wio Terminal'in sağ tarafındaki pinlere bağlanmış hali](../../../../../translated_images/wio-respeaker-wiring-3.75b0be447e2fa930.tr.png)

    ![ReSpeaker'ın sağ tarafındaki pinlerin Wio Terminal'in sağ tarafındaki pinlere bağlanmış hali](../../../../../translated_images/wio-respeaker-wiring-4.aa9cd434d8779437.tr.png)
    ...
    >
    > ![Bantla sabitlenmiş pinler](../../../../../translated_images/wio-respeaker-wiring-5.af117c20acf622f3.tr.png)
...
1. Bir hoparlör eklemeniz gerekecek.
    ...
    * Eğer JST kablolu bir hoparlör kullanıyorsanız, bunu ReSpeaker üzerindeki JST portuna bağlayın.
      ...
      ![JST kablosuyla ReSpeaker'a bağlanmış bir hoparlör](../../../../../translated_images/respeaker-jst-speaker.a441d177809df945.tr.png)

    * Eğer 3.5mm jaklı bir hoparlör veya kulaklık kullanıyorsanız, bunu 3.5mm jak soketine takın.

      ![3.5mm jak soketiyle ReSpeaker'a bağlanmış bir hoparlör](../../../../../translated_images/respeaker-35mm-speaker.ad79ef4f128c7751.tr.png)
...
1. SD kartı, Wio Terminal'in sol tarafındaki güç düğmesinin hemen altındaki SD Kart yuvasına yerleştirin. Kartın tamamen yerleştiğinden ve tıklandığından emin olun - bunu yapmak için ince bir alet veya başka bir SD Kart kullanmanız gerekebilir.
    ...
    ![SD kartı güç düğmesinin altındaki SD kart yuvasına yerleştirme](../../../../../translated_images/wio-sd-card.acdcbe322fa4ee7f.tr.png)
