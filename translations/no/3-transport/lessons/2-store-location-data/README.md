...
![En relasjonsdatabase med ID-en fra User-tabellen som relaterer til user ID-kolonnen i purchases-tabellen, og ID-en fra products-tabellen som relaterer til product ID i purchases-tabellen](../../../../../translated_images/no/sql-database.be160f12bfccefd3.png)
...
![Sender GPS-telemetri fra en IoT-enhet til IoT Hub, deretter til Azure Functions via en Event Hub-utløser, og lagrer det deretter i blob-lagring](../../../../../translated_images/no/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
