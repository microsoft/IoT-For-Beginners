...
![Mikrofon pada Wio Terminal](../../../../../translated_images/id/wio-mic.3f8c843dbe8ad917.png)
...
![ReSpeaker 2-Mics Pi Hat](../../../../../translated_images/id/respeaker.f5d19d1c6b14ab16.png)
...
1. Dengan Wio Terminal dalam keadaan mati, hubungkan ReSpeaker 2-Mics Pi Hat ke Wio Terminal menggunakan kabel jumper dan soket GPIO di bagian belakang Wio Terminal:
    ...
    ![Diagram pin](../../../../../translated_images/id/wio-respeaker-wiring-0.767f80aa65081038.png)
...
1. Ulangi proses ini hingga ke bawah soket GPIO di sisi kiri. Pastikan pin terpasang dengan kuat.
    ...
    ![ReSpeaker dengan pin sisi kiri terhubung ke pin sisi kiri Wio Terminal](../../../../../translated_images/id/wio-respeaker-wiring-1.8d894727f2ba2400.png)

    ![ReSpeaker dengan pin sisi kiri terhubung ke pin sisi kiri Wio Terminal](../../../../../translated_images/id/wio-respeaker-wiring-2.329e1cbd306e754f.png)
...
1. Ulangi proses ini menggunakan soket GPIO di sisi kanan pada ReSpeaker dan Wio Terminal. Kabel ini harus melewati kabel yang sudah terpasang.
    ...
    ![ReSpeaker dengan pin sisi kanan terhubung ke pin sisi kanan Wio Terminal](../../../../../translated_images/id/wio-respeaker-wiring-3.75b0be447e2fa930.png)

    ![ReSpeaker dengan pin sisi kanan terhubung ke pin sisi kanan Wio Terminal](../../../../../translated_images/id/wio-respeaker-wiring-4.aa9cd434d8779437.png)
    ...
    >
    > ![Pin yang diperbaiki dengan selotip](../../../../../translated_images/id/wio-respeaker-wiring-5.af117c20acf622f3.png)

1. Anda perlu menambahkan speaker.

    * Jika Anda menggunakan speaker dengan kabel JST, hubungkan ke port JST pada ReSpeaker.

      ![Speaker terhubung ke ReSpeaker dengan kabel JST](../../../../../translated_images/id/respeaker-jst-speaker.a441d177809df945.png)

    * Jika Anda menggunakan speaker dengan jack 3.5mm, atau headphone, masukkan ke soket jack 3.5mm.

      ![Speaker terhubung ke ReSpeaker melalui soket jack 3.5mm](../../../../../translated_images/id/respeaker-35mm-speaker.ad79ef4f128c7751.png)
...
1. Masukkan kartu SD ke slot kartu SD di sisi kiri Wio Terminal, tepat di bawah tombol daya. Pastikan kartu masuk sepenuhnya dan terkunci - Anda mungkin memerlukan alat tipis atau kartu SD lain untuk membantu mendorongnya masuk sepenuhnya.
    ...
    ![Memasukkan kartu SD ke slot kartu SD di bawah tombol daya](../../../../../translated_images/id/wio-sd-card.acdcbe322fa4ee7f.png)
