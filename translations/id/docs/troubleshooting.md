# Panduan Pemecahan Masalah Raspberry Pi

Panduan ini memberikan solusi untuk masalah umum yang ditemui saat menjalankan proyek IoT pada perangkat Raspberry Pi.  
Ini dirancang untuk pemula yang mengikuti kurikulum IoT-For-Beginners, tetapi juga berguna untuk pengembangan Pi secara umum.

---

## 1. Kesalahan Instalasi & Ketergantungan

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Ini terjadi saat modul Python yang diperlukan tidak terpasang.
