...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:57:29+00:00",
...
1. **Fork Repository**: Klik [![Fork GitHub](https://img.shields.io/github/forks/microsoft/IoT-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/IoT-For-Beginners/fork)
...
![Peta jalan untuk kursus yang menunjukkan 24 pelajaran mencakup pengenalan, pertanian, transportasi, pemrosesan, ritel, dan memasak](../../translated_images/Roadmap.bb1dec285dda0eda691788b95ddfc96d31d76bb7649e3f04a135e4ad395f323e.id.jpg)
...
Untuk video ringkasan tentang kursus ini, lihat video berikut:
...
Dengan memastikan bahwa konten sesuai dengan proyek, proses pembelajaran menjadi lebih menarik bagi siswa dan retensi konsep akan meningkat.
...
> 💁 Temukan [Kode Etik](CODE_OF_CONDUCT.md), [Kontribusi](CONTRIBUTING.md), dan panduan [Terjemahan](TRANSLATIONS.md). Kami menyambut umpan balik konstruktif Anda!
...
|       |              Nama Proyek              |                       Konsep yang Diajarkan                       | Tujuan Pembelajaran                                                                                                                                                 |                                                        Tautan Pelajaran                                                         |
| :---: | :------------------------------------: | :---------------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------------------------------------------------------------------------------------------------------------------------: |
|  01   | [Memulai](./1-getting-started/README.md) |                     Pengantar IoT                     | Pelajari prinsip dasar IoT dan komponen utama solusi IoT seperti sensor dan layanan cloud sambil menyiapkan perangkat IoT pertama Anda |                      [Pengantar IoT](./1-getting-started/lessons/1-introduction-to-iot/README.md)                      |
...
|  03   | [Memulai](./1-getting-started/README.md) | Berinteraksi dengan dunia fisik menggunakan sensor dan aktuator | Pelajari tentang sensor untuk mengumpulkan data dari dunia fisik, dan aktuator untuk memberikan umpan balik, sambil membangun lampu malam                                           | [Berinteraksi dengan dunia fisik menggunakan sensor dan aktuator](./1-getting-started/lessons/3-sensors-and-actuators/README.md) |
...
|  08   |            [Pertanian](./2-farm/README.md)            |               Migrasikan tanaman Anda ke cloud               | Pelajari tentang cloud dan layanan IoT yang di-host di cloud serta cara menghubungkan tanaman Anda ke salah satu layanan ini daripada broker MQTT publik                                   |               [Migrasikan tanaman Anda ke cloud](./2-farm/lessons/4-migrate-your-plant-to-the-cloud/README.md)                |
...
|  19   |          [Ritel](./5-retail/README.md)          |                   Latih detektor stok                    | Pelajari cara menggunakan deteksi objek untuk melatih detektor stok untuk menghitung stok di toko                                                                                |                        [Latih detektor stok](./5-retail/lessons/1-train-stock-detector/README.md)                         |
...
|  21   |        [Konsumen](./6-consumer/README.md)        |             Kenali ucapan dengan perangkat IoT             | Pelajari cara mengenali ucapan dari perangkat IoT untuk membangun pengatur waktu pintar                                                                                             |                  [Kenali ucapan dengan perangkat IoT](./6-consumer/lessons/1-speech-recognition/README.md)                  |
...
|  23   |        [Konsumen](./6-consumer/README.md)        |           Atur pengatur waktu dan berikan umpan balik suara           | Pelajari cara mengatur pengatur waktu pada perangkat IoT dan memberikan umpan balik suara tentang kapan pengatur waktu diatur dan kapan selesai                                                    |                 [Atur pengatur waktu dan berikan umpan balik suara](./6-consumer/lessons/3-spoken-feedback/README.md)                  |
|  24   |        [Konsumen](./6-consumer/README.md)        |                 Dukung banyak bahasa                  | Pelajari cara mendukung banyak bahasa, baik yang diucapkan maupun respons dari pengatur waktu pintar Anda                                                               |                   [Dukung banyak bahasa](./6-consumer/lessons/4-multiple-language-support/README.md)                   |
...
Terima kasih kepada komunitas yang telah menyelenggarakan kuis interaktif untuk menguji pengetahuan Anda tentang setiap bab. Anda dapat menguji pengetahuan Anda [di sini](https://ff-quizzes.netlify.app/en/) 

### PDF

Anda dapat menghasilkan PDF dari konten ini untuk akses offline jika diperlukan. Untuk melakukan ini, pastikan Anda telah [menginstal npm](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) dan jalankan perintah berikut di folder root repositori ini:
