...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T06:39:41+00:00",
  "source_file": "docs/troubleshooting.md",
  "language_code": "fi"
}
-->
# Raspberry Pi Vianetsintäopas

Tämä opas tarjoaa ratkaisuja yleisiin ongelmiin, joita esiintyy IoT-projekteja ajettaessa Raspberry Pi -laitteilla.  
Se on suunnattu aloittelijoille, jotka seuraavat IoT-For-Beginners-kurssia, mutta on hyödyllinen myös yleiseen Pi-kehitykseen.

---

## 1. Asennus- ja riippuvuusvirheet

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Tämä tapahtuu, kun tarvittavia Python-moduuleja ei ole asennettu.
