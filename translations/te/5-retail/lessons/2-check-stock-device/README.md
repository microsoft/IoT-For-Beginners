...
![ఈ పాఠం యొక్క స్కెచ్‌నోట్ అవలోకనం](../../../../../translated_images/lesson-20.0211df9551a8abb3.te.jpg)
...
![షెల్ఫ్‌పై 7 ట్మాటో పేస్ట్ క్యాన్‌లు, పై వరుసలో 4, పైకు 3](../../../../../translated_images/stock-7-cans-tomato-paste.f86059cc573d7bec.te.png)
...
![ట్మాటో పేస్ట్ షెల్ఫ్ పై ఒక అనూహ్య బేబీ కారు క్యాన్](../../../../../translated_images/stock-rogue-corn.be1f3ada8c457854.te.png)
...
1. ఆ iteration కోసం **Publish** బటన్ ను ఎంచుకోండి
    ...
    ![ప్రచురణ బటన్](../../../../../translated_images/custom-vision-object-detector-publish-button.34ee379fc650ccb9.te.png)
...
1. ప్రచురించిన తర్వాత, **Prediction URL** బటన్‌ను ఎంచుకోండి. ఇది ప్రిడిక్షన్ API వివరాలను చూపిస్తుంది, మీరు ఈ వివరాలతో మీ IoT పరికరం నుండి మోడల్‌ను కాల్ చేయవచ్చు. దిగువ భాగం *If you have an image file* అని లేబుల్ చేయబడింది, ఇది మీరు కావలసిన వివరాలు. చూపిస్తున్న URLని కాపీ చేసుకోండి, ఇది ఇలా ఉంటుంది:
    ...
    ![ప్రిడిక్షన్ API డైలాగ్ URL మరియు కీతో](../../../../../translated_images/custom-vision-prediction-key-endpoint.30c569ffd0338864.te.png)
...
![35.8%, 33.5%, 25.7%, 16.6% అవకాశం ఉన్న 4 టమోటో పేస్ట్ క్యాన్‌లు షెల్ఫ్‌పై](../../../../../translated_images/custom-vision-stock-prediction.942266ab1bcca341.te.png)
...
![టమోటో పేస్ట్ క్యాన్ చుట్టూ ఉన్న బౌండింగ్ బాక్స్](../../../../../translated_images/bounding-box.1420a7ea0d3d15f7.te.png)
...
![రెండు బౌండింగ్ బాక్స్‌లు టమోటో పేస్ట్ క్యాన్ పై ఒకదాని లోపల ఇంకొకటి ముడిపడినవి](../../../../../translated_images/overlap-object-detection.d431e03cae75072a.te.png)
