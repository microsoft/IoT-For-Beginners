...
![A grove time of flight sensor](../../../../../translated_images/grove-time-of-flight-sensor.d82ff2165bfded9f.te.png)
...
![The grove time of flight sensor connected to the left hand socket](../../../../../translated_images/wio-time-of-flight-sensor.c4c182131d2ea73d.te.png)
...
1. ఈ కోడ్‌ను కంబైల్ చేసి, అప్లోడ్ చేసి, అమలు చేయండి. సీరియల్ మానిటర్‌లో దూర కొలతలను చూడగలరా. సెన్సార్ వెచ్చని వస్తువులను ఉంచండి మరియు మీరు దూర కొలతను చూడగలరు:
    ...
    ![The rangefinder on the back of the time of flight sensor pointing at a banana](../../../../../translated_images/time-of-flight-banana.079921ad8b1496e4.te.png)
