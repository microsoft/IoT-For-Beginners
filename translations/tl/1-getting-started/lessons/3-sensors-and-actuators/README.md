...
✅ Mag-research. Anong sensors ang mayroon sa iyong telepono?
...
> 🎓 Ito ay isang oversimplification, at maaari kang magbasa pa tungkol sa potentiometers at variable resistors sa [potentiometer Wikipedia page](https://wikipedia.org/wiki/Potentiometer).
...
> 💁 Ang mga boltahe ay hindi kailanman eksakto lalo na dahil ang mga components sa isang sensor ay may resistance, kaya karaniwang may tolerance. Halimbawa, ang GPIO pins sa isang Raspberry Pi ay gumagana sa 3.3V, at nagbabasa ng return signal na higit sa 1.8V bilang 1, mas mababa sa 1.8V bilang 0.
...
* Stepper motor - kinokonvert ang signal sa isang tiyak na dami ng pag-ikot, tulad ng pag-ikot ng dial ng 90°
...
✅ Mag-research. Anong actuators ang mayroon sa iyong telepono?
...
✅ Ano sa tingin mo ang mangyayari kung ang IoT device ay magpadala ng mas mataas na boltahe kaysa sa kayang tanggapin ng actuator?  
⛔️ HUWAG subukan ito.
...
✅ Paano mo mapapanatiling maayos ang pag-ikot ng motor, lalo na sa mababang bilis? Gagamit ka ba ng kaunting bilang ng mahahabang pulso na may mahahabang pahinga o maraming napakaikling pulso na may napakaikling pahinga?

> 💁 Ang ilang mga sensor ay gumagamit din ng PWM upang i-convert ang mga analog na signal sa digital na signal.
...
✅ Ano pang ibang simpleng 2-state actuator ang naiisip mo? Ang isang halimbawa ay isang solenoid, na isang electromagnet na maaaring i-activate upang gumawa ng mga bagay tulad ng paggalaw ng bolt ng pinto para sa pag-lock/pag-unlock ng pinto.
