...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:27:24+00:00",
...
1. Ang PyAudio Pip package ay may mga function para mag-record at mag-playback ng audio. Ang package na ito ay nangangailangan ng ilang audio libraries na kailangang i-install muna. Patakbuhin ang mga sumusunod na command sa terminal upang i-install ang mga ito:
...
1. Idagdag ang mga sumusunod na imports sa itaas ng file na ito:
    ...
    Ini-import nito ang `pyaudio` module, ilang standard na Python modules para mag-handle ng wave files, at ang `grove.factory` module para mag-import ng `Factory` upang gumawa ng button class.
...
1. Sa ibaba nito, ideklara ang sample rate na gagamitin para sa pagkuha at playback ng audio. Maaaring kailanganin mong baguhin ito depende sa hardware na ginagamit mo.
    ...
    Kung makakakuha ka ng sample rate errors kapag pinapatakbo ang code na ito, palitan ang value sa `44100` o `16000`. Mas mataas ang value, mas maganda ang kalidad ng tunog.
...
1. Idagdag ang sumusunod na code sa ibaba ng `capture_audio` function upang mag-loop hanggang sa pinindot ang button. Kapag pinindot ang button, kukunin ang audio, pagkatapos ay ipapatugtog.
...
1. Patakbuhin ang code. Pindutin ang button at magsalita sa mikropono. Bitiwan ang button kapag tapos ka na, at maririnig mo ang recording.
