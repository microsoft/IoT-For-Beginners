...
![Όταν πολλά γεγονότα αποστέλλονται ταυτόχρονα, η serverless υπηρεσία κλιμακώνεται για να τα επεξεργαστεί όλα ταυτόχρονα](../../../../../translated_images/serverless-scaling.f8c769adf0413fd1.el.png)
...
1. Ανοίξτε τον τρέχοντα φάκελο στο VS Code, είτε ανοίγοντας το VS Code και στη συνέχεια αυτόν τον φάκελο, είτε εκτελώντας την ακόλουθη εντολή:
    ...
    ![Η ειδοποίηση](../../../../../translated_images/vscode-azure-functions-init-notification.bd19b49229963edb.el.png)
