...
![Μια σκίτσο-παρουσίαση αυτής της ενότητας](../../../../../translated_images/el/lesson-16.215daf18b00631fb.webp)
...
![Το φως από μια σκηνή περνά μέσα από έναν φακό και εστιάζεται σε έναν αισθητήρα CMOS](../../../../../translated_images/el/cmos-sensor.75f9cd74decb1371.webp)
...
1. Επιλέξτε το κουμπί **Δημοσίευση** για την επανάληψη.
    ...
    ![Το κουμπί δημοσίευσης](../../../../../translated_images/el/custom-vision-publish-button.b7174e1977b0c33b.webp)
...
![2 εικόνες μπανάνας, μία χαμηλής ανάλυσης με κακό φωτισμό από συσκευή IoT, και μία υψηλής ανάλυσης με καλό φωτισμό από τηλέφωνο](../../../../../translated_images/el/banana-picture-compare.174df164dc326a42.webp)
