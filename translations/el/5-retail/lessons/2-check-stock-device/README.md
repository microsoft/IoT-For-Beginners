...
![Μια σκίτσο-παρουσίαση αυτής της ενότητας](../../../../../translated_images/el/lesson-20.0211df9551a8abb3.webp)
...
1. Επιλέξτε το κουμπί **Publish** για την έκδοση.
    ...
    ![Το κουμπί δημοσίευσης](../../../../../translated_images/el/custom-vision-object-detector-publish-button.34ee379fc650ccb9.webp)
...
1. Μόλις δημοσιευθεί, επιλέξτε το κουμπί **Prediction URL**. Αυτό θα εμφανίσει λεπτομέρειες για το API πρόβλεψης, τις οποίες θα χρειαστείτε για να καλέσετε το μοντέλο από τη συσκευή IoT σας. Το κάτω μέρος είναι με την ένδειξη *If you have an image file*, και αυτές είναι οι λεπτομέρειες που θέλετε. Αντιγράψτε το URL που εμφανίζεται, το οποίο θα είναι κάτι σαν:
    ...
    ![Ο διάλογος API πρόβλεψης που δείχνει το URL και το κλειδί](../../../../../translated_images/el/custom-vision-prediction-key-endpoint.30c569ffd0338864.webp)
...
![4 κονσέρβες τοματοπολτού σε ένα ράφι με προβλέψεις για τις 4 ανιχνεύσεις](../../../../../translated_images/el/custom-vision-stock-prediction.942266ab1bcca341.webp)
...
![Ένα πλαίσιο οριοθέτησης γύρω από μια κονσέρβα τοματοπολτού](../../../../../translated_images/el/bounding-box.1420a7ea0d3d15f7.webp)
...
![Δύο πλαίσια οριοθέτησης που επικαλύπτουν μια κονσέρβα τοματοπολτού](../../../../../translated_images/el/overlap-object-detection.d431e03cae75072a.webp)
