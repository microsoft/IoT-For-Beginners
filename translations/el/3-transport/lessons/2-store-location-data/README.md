...
![Σχεδιαστική σημείωση για αυτήν την ενότητα](../../../../../translated_images/el/lesson-12.ca7f53039712a3ec.webp)
...
![Έγγραφα σε φακέλους σε μια βάση δεδομένων NoSQL](../../../../../translated_images/el/noqsl-database.62d24ccf5b73f60d.webp)
...
![Αποστολή τηλεμετρίας GPS από μια συσκευή IoT στο IoT Hub](../../../../../translated_images/el/gps-telemetry-iot-hub.8115335d51cd2c12.webp)
...
![Το λογότυπο του Azure Storage](../../../../../translated_images/el/azure-storage-logo.605c0f602c640d48.webp)
