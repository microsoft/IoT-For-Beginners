...
![Μια σκιαγραφική επισκόπηση αυτού του μαθήματος](../../../../../translated_images/el/lesson-13.a259db1485021be7.webp)
...
![Διάγραμμα γραμμών των παραπάνω δεδομένων](../../../../../translated_images/el/chart-soil-moisture.fd6d9d0cdc0b5f75.webp)
...
![Διάγραμμα γραμμών υγρασίας εδάφους με γραμμή στο 450](../../../../../translated_images/el/chart-soil-moisture-relay.fbb391236d34a64d.webp)
...
![Το λογότυπο του Azure Maps](../../../../../translated_images/el/azure-maps-logo.35d01dcfbd81fe61.webp)
...
1. Κάτω από αυτό το script, προσθέστε ένα script block για να εκκινήσετε τον χάρτη.
    ...
    ![Ένας χάρτης που δείχνει το Σιάτλ, μια πόλη στην πολιτεία Ουάσινγκτον, ΗΠΑ](../../../../../translated_images/el/map-image.8fb2c53eb23ef39c.webp)
...
1. Φορτώστε την HTML σελίδα στο πρόγραμμα περιήγησής σας. Θα φορτώσει τον χάρτη, στη συνέχεια θα φορτώσει όλα τα δεδομένα GPS από την αποθήκευση και θα τα απεικονίσει στον χάρτη.
    ...
    ![Χάρτης του Saint Edward State Park κοντά στο Σιάτλ, με κύκλους που δείχνουν μια διαδρομή γύρω από την άκρη του πάρκου](../../../../../translated_images/el/map-path.896832e72dc696ff.webp)
