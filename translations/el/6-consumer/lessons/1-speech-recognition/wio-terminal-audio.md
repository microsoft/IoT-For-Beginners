...
![Ο ήχος από το μικρόφωνο περνάει σε έναν ADC και στη συνέχεια στον DMAC. Αυτός γράφει σε έναν buffer. Όταν αυτός ο buffer γεμίσει, επεξεργάζεται και ο DMAC γράφει σε έναν δεύτερο buffer](../../../../../translated_images/el/dmac-adc-buffers.4509aee49145c90b.webp)
