# Guide de dépannage pour Raspberry Pi

Ce guide fournit des solutions aux problèmes courants rencontrés lors de l'exécution de projets IoT sur des appareils Raspberry Pi.  
Il est conçu pour les débutants suivant le programme IoT-For-Beginners, mais est également utile pour le développement général sur Pi.

---

## 1. Erreurs d'installation et de dépendances

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Cela se produit lorsque les modules Python requis ne sont pas installés.
