...
![従来の開発では入力とアルゴリズムから出力を得る。機械学習では入力データと出力データを使ってモデルを訓練し、このモデルが新しい入力データから新しい出力を生成する](../../../../../translated_images/ja/traditional-vs-ml.5c20c169621fa539.webp)
...
![形状を認識できれば、それらを組み合わせてボートや猫を作ることができる](../../../../../translated_images/ja/shapes-to-images.1a309f0ea88dd66f.webp)
