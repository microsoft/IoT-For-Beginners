...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T15:33:52+00:00",
...
> **En anteckning om frågesporter**: Alla frågesporter finns i mappen quiz-app, totalt 48 frågesporter med tre frågor vardera. De är länkade från lektionerna, men frågesportsappen kan köras lokalt eller distribueras till Azure; följ instruktionerna i mappen `quiz-app`. De lokaliseras successivt.
## Lektioner

|       |              Projekt Namn              |                       Koncept som lärs ut                       | Lärandemål                                                                                                                                                          |                                                        Länkad Lektion                                                         |
| :---: | :------------------------------------: | :-------------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------: |
|  01   | [Komma igång](./1-getting-started/README.md) |                     Introduktion till IoT                     | Lär dig de grundläggande principerna för IoT och de grundläggande byggstenarna för IoT-lösningar, såsom sensorer och molntjänster, medan du sätter upp din första IoT-enhet |                      [Introduktion till IoT](./1-getting-started/lessons/1-introduction-to-iot/README.md)                      |
...
|  12   |       [Transport](./3-transport/README.md)       |                     Spara platsdata                     | Lär dig hur du sparar IoT-data för att visualiseras eller analyseras senare                                                                                        |                         [Spara platsdata](./3-transport/lessons/2-store-location-data/README.md)                         |
...
Det finns presentationsmaterial för vissa av lektionerna i [slides](../../slides)-mappen.
...
- [AI Agents för nybörjare](https://aka.ms/ai-agents-beginners)
