...
1. **Fork:a Repositoriet**: Klicka [![GitHub forks](https://img.shields.io/github/forks/microsoft/IoT-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/IoT-For-Beginners/fork)
...
![En roadmap för kursen som visar 24 lektioner som täcker intro, jordbruk, transport, bearbetning, detaljhandel och matlagning](../../translated_images/sv/Roadmap.bb1dec285dda0eda.webp)
