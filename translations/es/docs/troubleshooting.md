...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T12:42:22+00:00",
  "source_file": "docs/troubleshooting.md",
  "language_code": "es"
}
-->
# Guía de solución de problemas de Raspberry Pi

Esta guía proporciona soluciones a problemas comunes encontrados al ejecutar proyectos IoT en dispositivos Raspberry Pi.  
Está diseñada para principiantes que siguen el currículo IoT-For-Beginners, pero también es útil para el desarrollo general de Pi.

---

## 1. Errores de instalación y dependencias

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Esto sucede cuando los módulos de Python requeridos no están instalados.
...
**Aviso Legal**:
Este documento ha sido traducido utilizando el servicio de traducción automática [Co-op Translator](https://github.com/Azure/co-op-translator). Aunque nos esforzamos por la precisión, tenga en cuenta que las traducciones automatizadas pueden contener errores o inexactitudes. El documento original en su idioma nativo debe considerarse la fuente autorizada. Para información crítica, se recomienda la traducción profesional humana. No nos responsabilizamos de malentendidos o interpretaciones erróneas que puedan derivarse del uso de esta traducción.
