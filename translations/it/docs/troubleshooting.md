...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T04:03:30+00:00",
  "source_file": "docs/troubleshooting.md",
  "language_code": "it"
}
-->
# Guida alla Risoluzione dei Problemi del Raspberry Pi

Questa guida fornisce soluzioni ai problemi comuni riscontrati durante l'esecuzione di progetti IoT su dispositivi Raspberry Pi.  
È pensata per i principianti che seguono il curriculum IoT-For-Beginners, ma è utile anche per lo sviluppo generale su Pi.

---

## 1. Errori di Installazione e Dipendenze

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Questo accade quando i moduli Python richiesti non sono installati.
