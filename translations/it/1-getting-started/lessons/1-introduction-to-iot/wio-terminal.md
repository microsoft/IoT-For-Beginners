...
![Un Wio Terminal di Seeed Studios](../../../../../translated_images/wio-terminal.b8299ee16587db9a.it.png)
...
1. L'icona di PlatformIO sarà nella barra del menu laterale:
    ...
    ![L'opzione di menu PlatformIO](../../../../../translated_images/vscode-platformio-menu.297be26b9733e5c4.it.png)

    Seleziona questa voce di menu, quindi seleziona *PIO Home -> Open*.

    ![L'opzione di apertura PlatformIO](../../../../../translated_images/vscode-platformio-home-open.3f9a41bfd3f4da1c.it.png)

1. Dalla schermata di benvenuto, seleziona il pulsante **+ New Project**.

    ![Il pulsante per creare un nuovo progetto](../../../../../translated_images/vscode-platformio-welcome-new-button.ba6fc8a4c7b78cc8.it.png)
...
1. Configura il progetto nel *Project Wizard*:
    ...
    ![Il wizard del progetto completato](../../../../../translated_images/vscode-platformio-nightlight-project-wizard.5c64db4da6037420.it.png)
...
1. Compila e carica il codice sul Wio Terminal.
    ...
    1. Digita `PlatformIO Upload` per cercare l'opzione di upload e seleziona *PlatformIO: Upload*.
        ...
        ![L'opzione di upload di PlatformIO nel command palette](../../../../../translated_images/vscode-platformio-upload-command-palette.9e0f49cf80d1f1c3.it.png)
...
1. Digita `PlatformIO Serial` per cercare l'opzione Serial Monitor e seleziona *PlatformIO: Serial Monitor*.
    ...
    ![L'opzione Serial Monitor di PlatformIO nel command palette](../../../../../translated_images/vscode-platformio-serial-monitor-command-palette.b348ec841b8a1c14.it.png)
