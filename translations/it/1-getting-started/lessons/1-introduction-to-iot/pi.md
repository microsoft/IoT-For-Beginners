...
1. Dal Raspberry Pi Imager, seleziona il pulsante **CHOOSE OS**, quindi seleziona *Raspberry Pi OS (Other)*, seguito da *Raspberry Pi OS Lite (32-bit)*.
    ...
    ![Il Raspberry Pi Imager con Raspberry Pi OS Lite selezionato](../../../../../translated_images/it/raspberry-pi-imager.24aedeab9e233d84.webp)
...
1. Apri questa cartella in VS Code selezionando *File -> Apri...* e scegliendo la cartella *nightlight*, quindi seleziona **OK**.
    ...
    ![La finestra di dialogo di apertura di VS Code che mostra la cartella nightlight](../../../../../translated_images/it/vscode-open-nightlight-remote.d3d2a4011e30d535.webp)
