# Raspberry Pi Fehlerbehebungsanleitung

Dieser Leitfaden bietet Lösungen für häufig auftretende Probleme bei der Ausführung von IoT-Projekten auf Raspberry Pi Geräten.  
Er ist für Anfänger des IoT-For-Beginners Curriculums gedacht, ist aber auch für die allgemeine Pi-Entwicklung nützlich.

---

## 1. Installations- & Abhängigkeitsfehler

### ❗ `ModuleNotFoundError: Kein Modul namens 'xyz'`
Dies tritt auf, wenn erforderliche Python-Module nicht installiert sind.
