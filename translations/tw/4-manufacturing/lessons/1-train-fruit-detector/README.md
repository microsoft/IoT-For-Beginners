...
![傳統開發使用輸入和算法生成輸出。機器學習使用輸入和輸出數據訓練模型，該模型可以使用新輸入數據生成新輸出](../../../../../translated_images/tw/traditional-vs-ml.5c20c169621fa539.png)
...
![一旦能識別形狀，它們可以以不同的配置組成船或貓](../../../../../translated_images/tw/shapes-to-images.1a309f0ea88dd66f.png)
