...
1. 當 VS Code 啟動時，它將啟用 Python 虛擬環境。選定的虛擬環境將顯示在底部狀態欄中：
    ...
    ![VS Code 顯示選定的虛擬環境](../../../../../translated_images/tw/vscode-virtual-env.8ba42e04c3d533cf.png)
...
1. 你需要通過選擇 **Create a new integrated terminal** 按鈕啟動新的 VS Code 終端。這是因為 CounterFit 應用程式正在當前終端中運行。
    ...
    ![VS Code Create a new integrated terminal 按鈕](../../../../../translated_images/tw/vscode-new-terminal.77db8fc0f9cd3182.png)
