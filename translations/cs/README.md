...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:01:44+00:00",
...
Pokud narazíte na problém nebo máte otázky ohledně vytváření AI aplikací, připojte se k ostatním studentům a zkušeným vývojářům v diskusích o MCP. Je to podpůrná komunita, kde jsou otázky vítány a znalosti se sdílejí volně.  
...
3. [**Připojte se na Discord Microsoft Foundry a setkejte se s experty a ostatními vývojáři**](https://discord.com/invite/ByRwuEEgH4)  
...
Azure Cloud Advocates v Microsoftu s potěšením nabízejí 12týdenní kurikulum s 24 lekcemi zaměřenými na základy IoT. Každá lekce obsahuje kvízy před a po lekci, písemné pokyny k dokončení lekce, řešení, úkoly a další. Naše projektově orientovaná pedagogika vám umožní učit se při vytváření, což je osvědčený způsob, jak si osvojit nové dovednosti.  
...
> **Učitelé**, [přidali jsme několik návrhů](for-teachers.md), jak využít toto kurikulum. Pokud byste chtěli vytvořit vlastní lekce, přidali jsme také [šablonu lekce](lesson-template/README.md).  

> **[Studenti](https://aka.ms/student-page)**, pokud chcete toto kurikulum použít samostatně, forkněte celý repozitář a dokončete cvičení sami, začněte kvízem před lekcí, poté si přečtěte lekci a dokončete zbytek aktivit. Snažte se vytvářet projekty pochopením lekcí, místo abyste kopírovali kód řešení; tento kód je však k dispozici ve složkách /solutions v každé projektově orientované lekci. Dalším nápadem by bylo vytvořit studijní skupinu s přáteli a projít obsah společně. Pro další studium doporučujeme [Microsoft Learn](https://docs.microsoft.com/users/jimbobbennett/collections/ke2ehd351jopwr?WT.mc_id=academic-17441-jabenn).  
...
Při vytváření tohoto kurikula jsme zvolili dva pedagogické principy: zajistit, aby bylo projektově orientované, a zahrnout časté kvízy. Na konci této série studenti vytvoří systém monitorování a zavlažování rostlin, sledovač vozidel, chytrou továrnu pro sledování a kontrolu potravin a hlasem ovládaný kuchyňský časovač, a naučí se základy internetu věcí, včetně psaní kódu pro zařízení, připojení ke cloudu, analýzy telemetrie a provozování AI na okraji.  

Zajištěním, že obsah odpovídá projektům, je proces pro studenty poutavější a zlepšuje se zapamatování konceptů.  

Navíc nízkostresový kvíz před hodinou nastaví záměr studenta na učení daného tématu, zatímco druhý kvíz po hodině zajišťuje další zapamatování. Toto kurikulum bylo navrženo tak, aby bylo flexibilní a zábavné, a lze jej absolvovat celé nebo jen jeho část. Projekty začínají malými úkoly a postupně se stávají složitějšími na konci 12týdenního cyklu.  

Každý projekt je založen na reálném hardwaru dostupném studentům a nadšencům. Každý projekt se zaměřuje na konkrétní doménu projektu a poskytuje relevantní základní znalosti. Aby byl vývojář úspěšný, je užitečné rozumět doméně, ve které řeší problémy. Poskytnutí těchto základních znalostí umožňuje studentům přemýšlet o svých IoT řešeních a poznatcích v kontextu reálného problému, který by mohli být požádáni řešit jako IoT vývojáři. Studenti se učí „proč“ řešení, která vytvářejí, a získávají ocenění pro koncového uživatele.  

## Hardware  

Máme dvě možnosti IoT hardwaru, které lze použít pro projekty, v závislosti na osobních preferencích, znalostech programovacího jazyka nebo preferencích, cílech učení a dostupnosti. Poskytli jsme také verzi „virtuálního hardwaru“ pro ty, kteří nemají přístup k hardwaru nebo se chtějí naučit více, než se rozhodnou pro nákup. Více informací a „nákupní seznam“ najdete na [stránce o hardwaru](./hardware.md), včetně odkazů na nákup kompletních sad od našich přátel v Seeed Studio.  
...
> **Poznámka k kvízům**: Všechny kvízy jsou obsaženy ve složce quiz-app, celkem 48 kvízů, každý se třemi otázkami. Jsou propojeny v rámci lekcí, ale aplikaci kvízů lze spustit lokálně nebo nasadit na Azure; postupujte podle pokynů ve složce `quiz-app`. Postupně jsou lokalizovány.

## Lekce

|       |              Název projektu              |                       Učené koncepty                       | Cíle učení                                                                                                                                                          |                                                        Propojená lekce                                                        |
| :---: | :--------------------------------------: | :---------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------: |
...
|  05   |            [Farma](./2-farm/README.md)            |                    Předpověď růstu rostlin                     | Naučte se předpovídat růst rostlin pomocí teplotních dat zachycených IoT zařízením                                                                                  |                          [Předpověď růstu rostlin](./2-farm/lessons/1-predict-plant-growth/README.md)                           |
...
|  07   |            [Farma](./2-farm/README.md)            |                  Automatické zalévání rostlin                   | Naučte se automatizovat a načasovat zalévání pomocí relé a MQTT                                                                                                    |                      [Automatické zalévání rostlin](./2-farm/lessons/3-automated-plant-watering/README.md)                       |
...
|  09   |            [Farma](./2-farm/README.md)            |         Migrace logiky aplikace do cloudu         | Naučte se, jak můžete psát logiku aplikace v cloudu, která reaguje na IoT zprávy                                                                                   |         [Migrace logiky aplikace do cloudu](./2-farm/lessons/5-migrate-application-to-the-cloud/README.md)         |
...
|  11   |       [Doprava](./3-transport/README.md)       |                      Sledování polohy                      | Naučte se o sledování polohy GPS pro IoT zařízení                                                                                                                   |                           [Sledování polohy](./3-transport/lessons/1-location-tracking/README.md)                           |
...
|  13   |       [Doprava](./3-transport/README.md)       |                   Vizualizace dat o poloze                   | Naučte se vizualizovat data o poloze na mapě a jak mapy reprezentují skutečný 3D svět ve 2 rozměrech                                                               |                     [Vizualizace dat o poloze](./3-transport/lessons/3-visualize-location-data/README.md)                     |
|  14   |       [Doprava](./3-transport/README.md)       |                          Geofencing                          | Naučte se o geofencích a jak je lze použít k upozornění, když se vozidla v dodavatelském řetězci blíží ke svému cíli                                               |                                   [Geofencing](./3-transport/lessons/4-geofences/README.md)                                   |
...
|  18   |   [Výroba](./4-manufacturing/README.md)   |        Spouštění detekce kvality ovoce ze senzoru        | Naučte se spouštět detekci kvality ovoce ze senzoru                                                                                                                |        [Spouštění detekce kvality ovoce ze senzoru](./4-manufacturing/lessons/4-trigger-fruit-detector/README.md)         |
...
|  24   |        [Spotřebitel](./6-consumer/README.md)        |                 Podpora více jazyků                  | Naučte se podporovat více jazyků, jak pro mluvené vstupy, tak pro odpovědi z vašeho chytrého časovače                                                              |                   [Podpora více jazyků](./6-consumer/lessons/4-multiple-language-support/README.md)                   |
...
Děkujeme komunitě za hostování interaktivního kvízu, který testuje vaše znalosti z každé kapitoly. Své znalosti můžete otestovat [zde](https://ff-quizzes.netlify.app/en/) 
