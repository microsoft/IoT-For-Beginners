...
1. 創建一個距離感測器：
    ...
    ![距離感測器設置](../../../../../translated_images/zh-TW/counterfit-create-distance-sensor.967c9fb98f27888d.webp)

    距離感測器將被創建並顯示在感測器列表中。

    ![距離感測器已創建](../../../../../translated_images/zh-TW/counterfit-distance-sensor.079eefeeea0b68af.webp)
