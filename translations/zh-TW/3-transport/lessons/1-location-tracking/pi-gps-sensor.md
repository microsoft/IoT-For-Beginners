...
![Grove GPS 感測器](../../../../../translated_images/zh-TW/grove-gps-sensor.247943bf69b03f0d.webp)
...
1. 在 Raspberry Pi 關機的情況下，將 Grove 電纜的另一端連接到 Pi 上的 Grove Base Hat 的 **UART** 插座。此插座位於中間排，靠近 SD 卡插槽的一側，遠離 USB 端口和以太網插座。
    ...
    ![Grove GPS 感測器連接到 UART 插座](../../../../../translated_images/zh-TW/pi-gps-sensor.1f99ee2b2f652891.webp)
