...
1. 從 VS Code 的終端運行以下命令啟動 CounterFit 應用程式：
    ...
    ![Counter Fit 應用程式在瀏覽器中運行](../../../../../translated_images/zh-TW/counterfit-first-run.433326358b669b31.webp)
...
1. 在此新終端中，像之前一樣運行 `app.py` 文件。CounterFit 的狀態將更改為 **Connected**，LED 會亮起。
    ...
    ![Counter Fit 顯示為已連接](../../../../../translated_images/zh-TW/counterfit-connected.ed30b46d8f79b092.webp)
