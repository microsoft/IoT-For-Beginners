...
1. 創建一個土壤濕度傳感器：
    ...
    ![土壤濕度傳感器設置](../../../../../translated_images/zh-TW/counterfit-create-soil-moisture-sensor.35266135a5e0ae68.webp)

    土壤濕度傳感器將被創建並顯示在傳感器列表中。

    ![已創建的土壤濕度傳感器](../../../../../translated_images/zh-TW/counterfit-soil-moisture-sensor.81742b2de0e9de60.webp)
