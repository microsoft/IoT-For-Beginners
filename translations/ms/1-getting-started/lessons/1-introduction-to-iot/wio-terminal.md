...
![Wio Terminal dari Seeed Studios](../../../../../translated_images/ms/wio-terminal.b8299ee16587db9a.png)
...
1. Ikon PlatformIO akan berada di bar menu sisi:
    ...
    ![Pilihan menu PlatformIO](../../../../../translated_images/ms/vscode-platformio-menu.297be26b9733e5c4.png)

    Pilih item menu ini, kemudian pilih *PIO Home -> Open*

    ![Pilihan buka PlatformIO](../../../../../translated_images/ms/vscode-platformio-home-open.3f9a41bfd3f4da1c.png)

1. Dari skrin selamat datang, pilih butang **+ New Project**

    ![Butang projek baru](../../../../../translated_images/ms/vscode-platformio-welcome-new-button.ba6fc8a4c7b78cc8.png)
...
1. Konfigurasikan projek dalam *Project Wizard*:
    ...
    ![Wizard projek yang lengkap](../../../../../translated_images/ms/vscode-platformio-nightlight-project-wizard.5c64db4da6037420.png)
...
1. Bina dan muat naik kod ke Wio Terminal
    ...
    1. Taip `PlatformIO Upload` untuk mencari pilihan muat naik, dan pilih *PlatformIO: Upload*
        ...
        ![Pilihan muat naik PlatformIO dalam palet arahan](../../../../../translated_images/ms/vscode-platformio-upload-command-palette.9e0f49cf80d1f1c3.png)
...
1. Taip `PlatformIO Serial` untuk mencari pilihan Serial Monitor, dan pilih *PlatformIO: Serial Monitor*
    ...
    ![Pilihan Serial Monitor PlatformIO dalam palet arahan](../../../../../translated_images/ms/vscode-platformio-serial-monitor-command-palette.b348ec841b8a1c14.png)
