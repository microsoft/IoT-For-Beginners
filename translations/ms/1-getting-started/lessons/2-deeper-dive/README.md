...
✅ Fikirkan sistem lain di sekeliling anda yang membaca data dari sensor dan menggunakannya untuk membuat keputusan. Satu contoh adalah termostat pada ketuhar. Bolehkah anda mencari lebih banyak?
...
✅ Apakah data lain yang boleh membantu membuat termostat yang disambungkan ke Internet menjadi lebih pintar?
...
✅ Fikirkan senario lain di mana privasi adalah penting sehingga pemprosesan data lebih baik dilakukan di tepi daripada di awan. Sebagai petunjuk - fikirkan peranti IoT dengan kamera atau peranti pengimejan lain di atasnya.
...
> 💁 Kadang-kadang peranti IoT dan peranti tepi berjalan di rangkaian yang sepenuhnya diasingkan dari Internet untuk memastikan data peribadi dan selamat. Ini dikenali sebagai [air-gapping](https://wikipedia.org/wiki/Air_gap_(networking)).
...
✅ Komputer PC atau Mac biasa mempunyai CPU dengan pelbagai teras yang berjalan pada pelbagai GigaHertz, bermaksud detik jam berdetik berbilion kali sesaat. Selidik kelajuan jam komputer anda dan bandingkan berapa kali lebih cepat ia daripada Wio Terminal.
...
> 💁 Sesetengah PC dan Mac mengadaptasi campuran teras kuasa tinggi yang cepat dan teras kuasa rendah yang lebih perlahan, beralih untuk menjimatkan bateri. Contohnya, cip M1 dalam komputer riba Apple terkini boleh beralih antara 4 teras prestasi dan 4 teras kecekapan untuk mengoptimumkan hayat bateri atau kelajuan bergantung pada tugas yang dijalankan.

✅ Lakukan sedikit penyelidikan: Baca tentang CPU di [artikel Wikipedia CPU](https://wikipedia.org/wiki/Central_processing_unit)
...
> 💁 Terdapat juga Pi400 komputer semua dalam satu dengan Pi4 terbina dalam papan kekunci.
...
✅ Apakah bahasa pengaturcaraan yang anda biasa? Adakah ia disokong pada Linux?
