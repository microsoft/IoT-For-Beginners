...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:43:41+00:00",
...
1. Pemasa pintar anda akan mempunyai 2 bahasa yang ditetapkan - bahasa pelayan yang digunakan untuk melatih LUIS (bahasa yang sama juga digunakan untuk membina mesej untuk bercakap dengan pengguna), dan bahasa yang dituturkan oleh pengguna. Kemas kini pembolehubah `language` kepada bahasa yang akan dituturkan oleh pengguna, dan tambahkan pembolehubah baharu yang dipanggil `server_language` untuk bahasa yang digunakan untuk melatih LUIS:
...
1. Gantikan deklarasi `recognizer_config` dan `recognizer` dengan yang berikut:
    ...
    Ini mencipta konfigurasi terjemahan untuk mengenali ucapan dalam bahasa pengguna, dan mencipta terjemahan dalam bahasa pengguna dan pelayan. Ia kemudian menggunakan konfigurasi ini untuk mencipta pengenal terjemahan - pengenal ucapan yang boleh menterjemah output pengenalan ucapan ke dalam pelbagai bahasa.
...
1. Kemas kini fungsi `recognized`, gantikan keseluruhan kandungan fungsi dengan yang berikut:
    ...
    Kamus `args.result.translations` menggunakan kunci bahagian bahasa dari tetapan lokal, bukan keseluruhan tetapan. Sebagai contoh, jika anda meminta terjemahan ke dalam `fr-FR` untuk Bahasa Perancis, kamus akan mengandungi entri untuk `fr`, bukan `fr-FR`.
...
1. Kembalikan sifat `text` daripada terjemahan pertama dari item pertama dalam array:
