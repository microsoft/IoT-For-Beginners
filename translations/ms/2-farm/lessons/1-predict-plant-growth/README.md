...
> 💁 Jika anda menggunakan Peranti IoT Maya, pilih kotak semak rawak dan tetapkan julat untuk mengelakkan mendapatkan suhu yang sama setiap kali nilai suhu dikembalikan.
    ...
    > 💁 Jika anda ingin menjalankan ini sepanjang hari, pastikan komputer yang menjalankan kod pelayan anda tidak masuk ke mod tidur, sama ada dengan menukar tetapan kuasa anda, atau menjalankan sesuatu seperti [skrip Python ini untuk memastikan sistem aktif](https://github.com/jaqsparow/keep-system-active).
...
1. Cari suhu asas untuk tumbuhan. Sebagai contoh, untuk strawberi suhu asas adalah 10°C.
...
Sebagai contoh, jika suhu tertinggi untuk hari tersebut adalah 25°C, dan suhu terendah adalah 12°C:
