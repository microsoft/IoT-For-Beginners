...
> 🎓 *Beban kerja* adalah istilah untuk mana-mana perkhidmatan yang melakukan kerja, seperti model AI, aplikasi, atau fungsi tanpa pelayan.
...
1. Jalankan arahan berikut untuk membina dan menandai imej:
    ...
    > 💁 Jika anda menjalankan arahan ini dari peranti yang anda jalankan IoT Edge, seperti menjalankan ini dari Raspberry Pi anda, anda boleh mengabaikan bahagian `--platform <platform>` kerana ia secara lalai kepada platform semasa.
