# Panduan Penyelesaian Masalah Raspberry Pi

Panduan ini menyediakan penyelesaian kepada masalah biasa yang dihadapi semasa menjalankan projek IoT pada peranti Raspberry Pi.  
Ia direka untuk pemula yang mengikuti kurikulum IoT-For-Beginners, tetapi juga berguna untuk pembangunan Pi secara umum.

---

## 1. Ralat Pemasangan & Kebergantungan

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Ini terjadi apabila modul Python yang diperlukan tidak dipasang.
