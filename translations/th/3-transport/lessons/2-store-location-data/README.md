...
![ฐานข้อมูลเชิงสัมพันธ์ที่ ID ของตารางผู้ใช้เชื่อมโยงกับคอลัมน์ ID ผู้ใช้ของตารางการซื้อ และ ID ของตารางผลิตภัณฑ์เชื่อมโยงกับ ID ผลิตภัณฑ์ของตารางการซื้อ](../../../../../translated_images/th/sql-database.be160f12bfccefd3.png)
...
![การส่งข้อมูล GPS จากอุปกรณ์ IoT ไปยัง IoT Hub จากนั้นไปยัง Azure Functions ผ่านตัวกระตุ้น Event Hub และบันทึกลงใน Blob Storage](../../../../../translated_images/th/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
