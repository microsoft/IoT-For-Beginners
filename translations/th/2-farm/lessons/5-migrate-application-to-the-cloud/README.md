...
![ภาพสเก็ตโน้ตสรุปบทเรียนนี้](../../../../../translated_images/th/lesson-9.dfe99c8e891f48e179724520da9f5794392cf9a625079281ccdcbf09bd85e1b6.jpg)
...
![เหตุการณ์ที่ถูกส่งจากบริการ IoT ไปยังบริการแบบไร้เซิร์ฟเวอร์ ซึ่งถูกประมวลผลพร้อมกันโดยฟังก์ชันหลายตัว](../../../../../translated_images/th/iot-messages-to-serverless.0194da1cc0732bb7d0f823aed3fce54735c6b1ad3bf36089804d8aaefc0a774f.png)
...
![เมื่อมีเหตุการณ์จำนวนมากเกิดขึ้นพร้อมกัน บริการแบบไร้เซิร์ฟเวอร์จะขยายตัวเพื่อรองรับการทำงานพร้อมกัน](../../../../../translated_images/th/serverless-scaling.f8c769adf0413fd1.png)
...
![โลโก้ Azure Functions](../../../../../translated_images/th/azure-functions-logo.1cfc8e3204c9c44aaf80fcf406fc8544d80d7f00f8d3e8ed6fed764563e17564.png)
...
1. เปิดโฟลเดอร์ปัจจุบันใน VS Code โดยเปิด VS Code แล้วเปิดโฟลเดอร์นี้ หรือรันคำสั่งต่อไปนี้:
    ...
    ![การแจ้งเตือน](../../../../../translated_images/th/vscode-azure-functions-init-notification.bd19b49229963edb.png)
