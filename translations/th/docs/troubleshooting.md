...
เหตุการณ์นี้เกิดขึ้นเมื่อโมดูล Python ที่จำเป็นไม่ได้ถูกติดตั้ง
