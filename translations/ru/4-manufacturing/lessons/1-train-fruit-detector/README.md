...
![Традиционная разработка использует входные данные и алгоритм для получения результата. Машинное обучение использует входные данные и результаты для обучения модели, которая затем может принимать новые данные и выдавать новые результаты](../../../../../translated_images/ru/traditional-vs-ml.5c20c169621fa539.png)
...
![Когда вы можете распознавать формы, их можно комбинировать в разные конфигурации, чтобы получить лодку или кошку](../../../../../translated_images/ru/shapes-to-images.1a309f0ea88dd66f.png)
