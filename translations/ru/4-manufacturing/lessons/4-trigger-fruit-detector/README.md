...
![Датчики приближения отправляют лазерные лучи к объектам, таким как бананы, и измеряют время, за которое луч возвращается](../../../../../translated_images/ru/proximity-sensor.f5cd752c77fb62fe.png)
