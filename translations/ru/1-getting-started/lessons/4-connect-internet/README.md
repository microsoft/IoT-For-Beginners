...
![IoT-устройства подключаются к брокеру, публикуют телеметрию и подписываются на команды. Облачные сервисы подключаются к брокеру, подписываются на всю телеметрию и отправляют команды конкретным устройствам.](../../../../../translated_images/ru/pub-sub.7c7ed43fe9fd15d4.png)
...
![Термостат, подключенный к Интернету, использующий несколько датчиков температуры](../../../../../translated_images/ru/telemetry.21e5d8b97649d2eb.png)
...
1. Когда VS Code запустится, он активирует виртуальное окружение Python. Это будет отображено в нижней строке состояния:
    ...
    ![VS Code показывает выбранное виртуальное окружение](../../../../../translated_images/ru/vscode-virtual-env.8ba42e04c3d533cf.png)
...
1. Если терминал VS Code уже запущен при старте VS Code, виртуальное окружение в нем не будет активировано. Самое простое решение — завершить работу терминала, нажав кнопку **Kill the active terminal instance**:
    ...
    ![Кнопка завершения работы терминала в VS Code](../../../../../translated_images/ru/vscode-kill-terminal.1cc4de7c6f25ee08.png)
