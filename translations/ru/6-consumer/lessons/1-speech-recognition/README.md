...
* Ленточные — Ленточные микрофоны похожи на динамические, но вместо диафрагмы у них металлическая лента. Эта лента движется в магнитном поле, генерируя электрический ток. Как и динамические микрофоны, ленточные микрофоны не требуют питания.
    ...
    ![Эдмунд Лоу, американский актер, стоит у радиомикрофона (обозначен как (NBC) Blue Network), держит сценарий, 1942 год](../../../../../translated_images/ru/ribbon-mic.eacc8e092c7441ca.jpg)
...
![График, показывающий сигнал с дискретными точками через фиксированные интервалы](../../../../../translated_images/ru/sampling.6f4fadb3f2d9dfe7.png)
