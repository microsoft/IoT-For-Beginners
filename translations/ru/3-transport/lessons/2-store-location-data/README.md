...
![Реляционная база данных, где ID таблицы пользователей связан с колонкой user ID таблицы покупок, а ID таблицы продуктов связан с колонкой product ID таблицы покупок](../../../../../translated_images/ru/sql-database.be160f12bfccefd3.png)
...
![Отправка телеметрии GPS с IoT-устройства в IoT Hub, затем в Azure Functions через триггер Event Hub, затем сохранение в хранилище блобов](../../../../../translated_images/ru/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
