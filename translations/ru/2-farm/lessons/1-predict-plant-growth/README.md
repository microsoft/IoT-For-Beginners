...
![График, показывающий, как скорость роста увеличивается с повышением температуры, а затем падает при слишком высокой температуре](../../../../../translated_images/plant-growth-temp-graph.c6d69c9478e6ca83.ru.png)
...
> 💁 Если вы используете виртуальное IoT-устройство, выберите случайный флажок и установите диапазон, чтобы избежать получения одинаковой температуры каждый раз, когда возвращается значение температуры.
    ![Выберите случайный флажок и установите диапазон](../../../../../translated_images/select-the-random-checkbox-and-set-a-range.32cf4bc7c12e797f.ru.png) 
