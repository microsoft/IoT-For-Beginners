...
![Когда множество событий отправляется одновременно, серверless-сервис масштабируется, чтобы обработать их все одновременно](../../../../../translated_images/ru/serverless-scaling.f8c769adf0413fd1.png)
...
1. Откройте текущую папку в VS Code, либо запустив VS Code и открыв эту папку, либо выполнив следующую команду:
    ...
    ![Уведомление](../../../../../translated_images/ru/vscode-azure-functions-init-notification.bd19b49229963edb.png)
