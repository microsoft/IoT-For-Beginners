...
![Когда реле включено, электромагнит создает магнитное поле, замыкая выходную цепь](../../../../../translated_images/ru/relay-on.4db16a0fd6b66926.png)
...
![Когда реле выключено, электромагнит не создает магнитного поля, размыкая выходную цепь](../../../../../translated_images/ru/relay-off.c34a178a2960fecd.png)
...
![Насос, подключенный через реле](../../../../../translated_images/ru/pump-wired-to-relay.66c5cfc0d8918990.png)
...
![Измерение влажности почвы 658 не изменяется во время полива, оно падает до 320 только после того, как вода пропитает почву](../../../../../translated_images/ru/soil-moisture-travel.a0e31af222cf1438.png)
...
![Растение клубники, подключенное к воде через насос, с насосом, подключенным к реле. Реле и датчик влажности почвы подключены к Raspberry Pi](../../../../../translated_images/ru/strawberry-with-pump.b410fc72ac6aabad.png)
...
![Шаг 1: измерить. Шаг 2: добавить воду. Шаг 3: подождать, пока вода пропитает почву. Шаг 4: повторно измерить](../../../../../translated_images/ru/soil-moisture-delay.865f3fae206db01d.png)
