...
![Скетчноут с обзором урока](../../../../../translated_images/ru/lesson-20.0211df9551a8abb300fc8fcf7dc2789468dea2eabe9202273ac077b0ba37f15e.jpg)
...
1. Нажмите кнопку **Publish** для итерации.
    ...
    ![Кнопка публикации](../../../../../translated_images/ru/custom-vision-object-detector-publish-button.34ee379fc650ccb9856c3868d0003f413b9529f102fc73c37168c98d721cc293.png)
...
1. После публикации нажмите кнопку **Prediction URL**. Это покажет детали API предсказаний, которые вам понадобятся для вызова модели с вашего IoT-устройства. Нижняя часть окна помечена как *If you have an image file*, и это те данные, которые вам нужны. Скопируйте URL, который будет выглядеть примерно так:
    ...
    ![Диалог API предсказаний, показывающий URL и ключ](../../../../../translated_images/ru/custom-vision-prediction-key-endpoint.30c569ffd0338864f319911f052d5e9b8c5066cb0800a26dd6f7ff5713130ad8.png)
...
![Граница вокруг банки томатной пасты](../../../../../translated_images/ru/bounding-box.1420a7ea0d3d15f71e1ffb5cf4b2271d184fac051f990abc541975168d163684.png)
...
![Две границы перекрывают банку томатной пасты](../../../../../translated_images/ru/overlap-object-detection.d431e03cae75072a2760430eca7f2c5fdd43045bfd72dadcbf12711f7cd6c2ae.png)
