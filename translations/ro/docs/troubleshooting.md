...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T16:09:00+00:00",
  "source_file": "docs/troubleshooting.md",
  "language_code": "ro"
}
-->
# Ghid de depanare Raspberry Pi

Acest ghid oferă soluții pentru probleme comune întâlnite în timpul derulării proiectelor IoT pe dispozitive Raspberry Pi.  
Este conceput pentru începători care urmează curriculum-ul IoT-For-Beginners, dar este util și pentru dezvoltarea generală pe Pi.

---

## 1. Erori de instalare și dependențe

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Aceasta apare atunci când modulele Python necesare nu sunt instalate.
