...
![Када се више догађаја пошаље истовремено, серверлес услуга се скалира да их све обради истовремено](../../../../../translated_images/serverless-scaling.f8c769adf0413fd1.sr.png)
...
1. Отворите тренутни директоријум у VS Code, било тако што ћете отворити VS Code па затим овај директоријум, или покретањем следеће команде:
    ...
    ![Обавештење](../../../../../translated_images/vscode-azure-functions-init-notification.bd19b49229963edb.sr.png)
