...
![Релациона база података са ID корисника у табели User који се односи на колону user ID у табели куповина, и ID производа у табели Products који се односи на product ID у табели куповина](../../../../../translated_images/sr/sql-database.be160f12bfccefd3.png)
...
![Слање GPS телеметрије са IoT уређаја на IoT Hub, затим на Azure Functions преко тригера за догађаје Event Hub-а, а затим чување у блоб складиште](../../../../../translated_images/sr/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
