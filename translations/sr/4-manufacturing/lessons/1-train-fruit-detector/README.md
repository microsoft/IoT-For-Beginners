...
![Традиционални развој узима улазне податке и алгоритам и даје резултат. Машинско учење користи улазне и излазне податке за обуку модела, а тај модел може узети нове улазне податке за генерисање нових резултата](../../../../../translated_images/traditional-vs-ml.5c20c169621fa539.sr.png)
...
![Када можете препознати облике, они се могу поставити у различите конфигурације да би се направио чамац или мачка](../../../../../translated_images/shapes-to-images.1a309f0ea88dd66f.sr.png)
