...
![Traditional development dey use input and algorithm to get output. Machine learning dey use input and output data to train model, and di model fit use new input to give new output](../../../../../translated_images/pcm/traditional-vs-ml.5c20c169621fa539.webp)
...
![Once you sabi shapes, you fit arrange dem to make boat or cat](../../../../../translated_images/pcm/shapes-to-images.1a309f0ea88dd66f.webp)
