...
![전자석이 켜지면 자기장이 생성되어 출력 회로의 스위치를 켜는 모습](../../../../../translated_images/ko/relay-on.4db16a0fd6b66926.png)

릴레이에서는 제어 회로가 전자석에 전력을 공급합니다. 전자석이 켜지면 레버를 당겨 스위치를 움직이고, 접점을 닫아 출력 회로를 완성합니다.

![전자석이 꺼지면 자기장이 생성되지 않아 출력 회로의 스위치를 끄는 모습](../../../../../translated_images/ko/relay-off.c34a178a2960fecd.png)
...
![릴레이를 통해 연결된 펌프](../../../../../translated_images/ko/pump-wired-to-relay.66c5cfc0d8918990.png)
...
![토양 수분 측정값이 658일 때 물을 주어도 즉시 변하지 않으며, 물이 토양에 스며든 후에야 320으로 떨어지는 모습](../../../../../translated_images/ko/soil-moisture-travel.a0e31af222cf1438.png)
...
![딸기 식물이 펌프를 통해 물과 연결되어 있으며, 펌프는 릴레이에 연결되어 있습니다. 릴레이와 토양 수분 센서는 모두 Raspberry Pi에 연결되어 있습니다.](../../../../../translated_images/ko/strawberry-with-pump.b410fc72ac6aabad.png)
...
![1단계: 측정값 확인. 2단계: 물 추가. 3단계: 물이 토양에 스며들기를 기다림. 4단계: 측정값 다시 확인.](../../../../../translated_images/ko/soil-moisture-delay.865f3fae206db01d.png)
