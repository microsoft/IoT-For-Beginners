...
![이 강의에 대한 스케치노트 개요](../../../../../translated_images/ko/lesson-2.324b0580d620c25e.webp)
...
![온도와 다이얼을 IoT 장치의 입력으로, 히터 제어를 출력으로 보여주는 다이어그램](../../../../../translated_images/ko/basic-thermostat.a923217fd1f37e5a.webp)
...
![온도와 다이얼을 IoT 장치의 입력으로, IoT 장치가 클라우드와 양방향 통신을 하고, 클라우드가 전화와 양방향 통신을 하며, 히터 제어를 IoT 장치의 출력으로 보여주는 다이어그램](../../../../../translated_images/ko/mobile-controlled-thermostat.4a994010473d8d6a.webp)
...
![RAM에 저장된 프로그램에서 명령을 가져오고(fetch), 이를 해석(decode)한 후 CPU에서 실행(execute)하는 명령어 사이클](../../../../../translated_images/ko/fetch-decode-execute.2fd6f150f6280392.webp)
...
![Arduino 스케치가 먼저 setup을 실행한 후 loop를 반복 실행](../../../../../translated_images/ko/arduino-sketch.79590cb837ff7a7c.webp)
