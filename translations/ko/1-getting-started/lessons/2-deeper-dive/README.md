...
![RAM에 저장된 프로그램에서 명령을 가져오고(fetch), 이를 해석(decode)한 후 CPU에서 실행(execute)하는 명령어 사이클](../../../../../translated_images/fetch-decode-execute.2fd6f150f6280392807f4475382319abd0cee0b90058e1735444d6baa6f2078c.ko.png)
