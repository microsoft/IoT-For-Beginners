...
![이 강의에 대한 스케치노트 개요](../../../../../translated_images/ko/lesson-12.ca7f53039712a3ec.webp)
...
![User 테이블의 ID가 Purchases 테이블의 user ID 열과 관계를 맺고, Products 테이블의 ID가 Purchases 테이블의 product ID와 관계를 맺는 관계형 데이터베이스](../../../../../translated_images/ko/sql-database.be160f12bfccefd3.webp)
...
![NoSQL 데이터베이스의 폴더 안에 있는 문서들](../../../../../translated_images/ko/noqsl-database.62d24ccf5b73f60d.webp)
...
![IoT 장치에서 IoT Hub로 GPS 텔레메트리 전송](../../../../../translated_images/ko/gps-telemetry-iot-hub.8115335d51cd2c12.webp)
...
![IoT 장치에서 IoT Hub로 GPS 텔레메트리 전송 후 Event Hub 트리거를 통해 Azure Functions로 전송](../../../../../translated_images/ko/gps-telemetry-iot-hub-functions.24d3fa5592455e9f.webp)
...
![Azure Storage 로고](../../../../../translated_images/ko/azure-storage-logo.605c0f602c640d48.webp)
...
![IoT 장치에서 GPS 텔레메트리를 IoT Hub로 전송한 후, 이벤트 허브 트리거를 통해 Azure Functions로 전달하고 Blob 스토리지에 저장](../../../../../translated_images/ko/save-telemetry-to-storage-from-functions.ed3b1820980097f1.webp)
