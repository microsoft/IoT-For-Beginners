...
1. 创建一个距离传感器：
    ...
    ![距离传感器设置](../../../../../translated_images/zh-CN/counterfit-create-distance-sensor.967c9fb98f27888d.webp)

    距离传感器将被创建并显示在传感器列表中。

    ![已创建的距离传感器](../../../../../translated_images/zh-CN/counterfit-distance-sensor.079eefeeea0b68af.webp)
