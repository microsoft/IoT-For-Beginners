...
![本课的手绘笔记概览](../../../../../translated_images/zh-CN/lesson-13.a259db1485021be7.webp)
...
![上述数据的折线图](../../../../../translated_images/zh-CN/chart-soil-moisture.fd6d9d0cdc0b5f75.webp)

进一步优化，可以添加一条线，表示当土壤湿度读数达到 450 时自动浇水系统启动的时间点：

![带有 450 线的土壤湿度折线图](../../../../../translated_images/zh-CN/chart-soil-moisture-relay.fbb391236d34a64d.webp)
...
![Azure Maps 标志](../../../../../translated_images/zh-CN/azure-maps-logo.35d01dcfbd81fe61.webp)
...
1. 在该脚本下方，添加一个脚本块以启动地图。
    ...
    ![显示西雅图的地图，西雅图是美国华盛顿州的一个城市](../../../../../translated_images/zh-CN/map-image.8fb2c53eb23ef39c.webp)
...
1. 在浏览器中加载 HTML 页面。页面将加载地图，然后从存储中加载所有 GPS 数据并将其绘制在地图上。
    ...
    ![西雅图附近圣爱德华州立公园的地图，显示公园边缘路径上的圆形标记](../../../../../translated_images/zh-CN/map-path.896832e72dc696ff.webp)
