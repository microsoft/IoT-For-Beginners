...
![عندما يتم إرسال العديد من الأحداث في نفس الوقت، تقوم الخدمة بدون خادم بالتوسع لتشغيلها جميعًا في نفس الوقت](../../../../../translated_images/serverless-scaling.f8c769adf0413fd1.ar.png)
...
1. افتح المجلد الحالي في VS Code، إما عن طريق فتح VS Code ثم فتح هذا المجلد، أو عن طريق تشغيل الأمر التالي:
    ...
    ![الإشعار](../../../../../translated_images/vscode-azure-functions-init-notification.bd19b49229963edb.ar.png)
