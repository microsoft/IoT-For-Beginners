...
![رسم بياني يظهر معدل النمو يرتفع مع ارتفاع درجة الحرارة، ثم ينخفض عندما تصبح درجة الحرارة مرتفعة جداً](../../../../../translated_images/plant-growth-temp-graph.c6d69c9478e6ca83.ar.png)
...
![يتم إرسال بيانات القياس إلى الخادم ثم حفظها في قاعدة بيانات](../../../../../translated_images/save-telemetry-database.ddc9c6bea0c5ba39.ar.png)
...
> 💁 إذا كنت تستخدم جهاز إنترنت الأشياء الافتراضي، قم بتحديد مربع الاختيار العشوائي واضبط نطاقًا لتجنب الحصول على نفس درجة الحرارة في كل مرة يتم فيها إرجاع قيمة درجة الحرارة.
    ![حدد مربع الاختيار العشوائي واضبط نطاقًا](../../../../../translated_images/select-the-random-checkbox-and-set-a-range.32cf4bc7c12e797f.ar.png) 
