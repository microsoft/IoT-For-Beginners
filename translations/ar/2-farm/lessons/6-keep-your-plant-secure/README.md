...
![التشفير المتماثل يستخدم نفس المفتاح لتشفير وفك تشفير الرسالة](../../../../../translated_images/send-message-symmetric-key.a2e8ad0d495896ff.ar.png)

إذا تم سرقة المفتاح أثناء النقل، أو تم اختراق المرسل أو المستلم وتم العثور على المفتاح، يمكن كسر التشفير.

![التشفير المتماثل آمن فقط إذا لم يحصل القراصنة على المفتاح - إذا حصلوا عليه يمكنهم اعتراض وفك تشفير الرسالة](../../../../../translated_images/send-message-symmetric-key-hacker.e7cb53db1707adfb.ar.png)
...
![التشفير غير المتماثل يستخدم مفتاحًا مختلفًا للتشفير وفك التشفير. يتم إرسال مفتاح التشفير إلى أي مرسل للرسائل حتى يتمكن من تشفير الرسالة قبل إرسالها إلى المستلم الذي يمتلك المفاتيح](../../../../../translated_images/send-message-asymmetric.7abe327c62615b8c.ar.png)
...
![بدلاً من مشاركة مفتاح عام، يمكنك مشاركة شهادة. يمكن لمستخدم الشهادة التحقق من أنها تأتي منك عن طريق التحقق مع سلطة التصديق التي وقعتها.](../../../../../translated_images/send-message-certificate.9cc576ac1e46b76e.ar.png)
