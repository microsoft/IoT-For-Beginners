...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T15:04:42+00:00",
...
[![طلبات السحب على GitHub](https://img.shields.io/github/issues-pr/microsoft/IoT-For-Beginners.svg)](https://GitHub.com/microsoft/IoT-For-Beginners/pulls/)  
...
> 💁 اعثر على [مدونة قواعد السلوك](CODE_OF_CONDUCT.md)، [المساهمة](CONTRIBUTING.md)، و[إرشادات الترجمة](TRANSLATIONS.md). نحن نرحب بملاحظاتك البناءة!  
...
> **ملاحظة حول الاختبارات**: جميع الاختبارات موجودة في مجلد quiz-app، بإجمالي 48 اختبارًا يحتوي كل منها على ثلاثة أسئلة. يتم الربط بها من داخل الدروس، ولكن يمكن تشغيل تطبيق الاختبارات محليًا أو نشره على Azure؛ اتبع التعليمات الموجودة في مجلد `quiz-app`. يتم ترجمتها تدريجيًا.
## الدروس

|       |              اسم المشروع              |                       المفاهيم التي يتم تدريسها                       | الأهداف التعليمية                                                                                                                                                 |                                                        الدرس المرتبط                                                         |
| :---: | :------------------------------------: | :---------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------: |
|  01   | [البدء](./1-getting-started/README.md) |                     مقدمة إلى إنترنت الأشياء                     | تعلم المبادئ الأساسية لإنترنت الأشياء والمكونات الأساسية لحلول إنترنت الأشياء مثل المستشعرات والخدمات السحابية أثناء إعداد أول جهاز إنترنت أشياء خاص بك |                      [مقدمة إلى إنترنت الأشياء](./1-getting-started/lessons/1-introduction-to-iot/README.md)                      |
...
|  03   | [البدء](./1-getting-started/README.md) | التفاعل مع العالم المادي باستخدام المستشعرات والمحركات | تعلم عن المستشعرات لجمع البيانات من العالم المادي، والمحركات لإرسال ردود الفعل، أثناء بناء مصباح ليلي                                           | [التفاعل مع العالم المادي باستخدام المستشعرات والمحركات](./1-getting-started/lessons/3-sensors-and-actuators/README.md) |
|  04   | [البدء](./1-getting-started/README.md) |             توصيل جهازك بالإنترنت             | تعلم كيفية توصيل جهاز إنترنت الأشياء بالإنترنت لإرسال واستقبال الرسائل عن طريق توصيل المصباح الليلي بخادم MQTT                               |               [توصيل جهازك بالإنترنت](./1-getting-started/lessons/4-connect-internet/README.md)                |
...
|  07   |            [المزرعة](./2-farm/README.md)            |                  ري النباتات تلقائيًا                   | تعلم كيفية أتمتة وتوقيت الري باستخدام مرحل وخادم MQTT                                                                                                      |                      [ري النباتات تلقائيًا](./2-farm/lessons/3-automated-plant-watering/README.md)                       |
|  08   |            [المزرعة](./2-farm/README.md)            |               نقل بيانات النبات إلى السحابة               | تعلم عن الخدمات السحابية المستضافة لإنترنت الأشياء وكيفية توصيل نباتك بأحدها بدلاً من خادم MQTT العام                                   |               [نقل بيانات النبات إلى السحابة](./2-farm/lessons/4-migrate-your-plant-to-the-cloud/README.md)                |
...
|  10   |            [المزرعة](./2-farm/README.md)            |                   تأمين نباتك                    | تعلم عن الأمان في إنترنت الأشياء وكيفية تأمين نباتك باستخدام المفاتيح والشهادات                                                                          |                        [تأمين نباتك](./2-farm/lessons/6-keep-your-plant-secure/README.md)                         |
|  11   |       [النقل](./3-transport/README.md)       |                      تتبع الموقع                      | تعلم عن تتبع الموقع باستخدام نظام تحديد المواقع (GPS) لأجهزة إنترنت الأشياء                                                                                                                   |                           [تتبع الموقع](./3-transport/lessons/1-location-tracking/README.md)                           |
...
|  14   |       [النقل](./3-transport/README.md)       |                          الأسوار الجغرافية                          | تعلم عن الأسوار الجغرافية، وكيف يمكن استخدامها للتنبيه عند اقتراب المركبات في سلسلة التوريد من وجهتها                                           |                                   [الأسوار الجغرافية](./3-transport/lessons/4-geofences/README.md)                                   |
...
|  18   |   [التصنيع](./4-manufacturing/README.md)   |        تشغيل اكتشاف جودة الفاكهة من مستشعر        | تعلم كيفية تشغيل اكتشاف جودة الفاكهة من مستشعر                                                                                                        |        [تشغيل اكتشاف جودة الفاكهة من مستشعر](./4-manufacturing/lessons/4-trigger-fruit-detector/README.md)         |
...
|  20   |          [التجزئة](./5-retail/README.md)          |               التحقق من المخزون باستخدام جهاز إنترنت الأشياء                | تعلم كيفية التحقق من المخزون باستخدام جهاز إنترنت الأشياء ونموذج اكتشاف الكائنات                                                                                         |                     [التحقق من المخزون باستخدام جهاز إنترنت الأشياء](./5-retail/lessons/2-check-stock-device/README.md)                      |
...
|  22   |        [المستهلك](./6-consumer/README.md)        |                     فهم اللغة                     | تعلم كيفية فهم الجمل المنطوقة لجهاز إنترنت الأشياء                                                                                                           |                        [فهم اللغة](./6-consumer/lessons/2-language-understanding/README.md)                        |
|  23   |        [المستهلك](./6-consumer/README.md)        |           ضبط مؤقت وتقديم ردود فعل منطوقة           | تعلم كيفية ضبط مؤقت على جهاز إنترنت الأشياء وتقديم ردود فعل منطوقة عند ضبط المؤقت وعند انتهائه                                                    |                 [ضبط مؤقت وتقديم ردود فعل منطوقة](./6-consumer/lessons/3-spoken-feedback/README.md)                  |
...
توجد عروض تقديمية لبعض الدروس في مجلد [الشرائح](../../slides).
...
يمكنك العثور على جميع نسب الصور المستخدمة في هذا المنهج عند الحاجة في [نسب الصور](./attributions.md).
