...
* 緞帶式 - 緞帶式麥克風與動圈式麥克風類似，但它使用金屬緞帶代替振膜。該緞帶在磁場中移動時會產生電流。與動圈式麥克風一樣，緞帶式麥克風不需要電源。
    ...
    ![美國演員 Edmund Lowe 站在標有 (NBC) Blue Network 的廣播麥克風前，手持劇本，1942年](../../../../../translated_images/ribbon-mic.eacc8e092c7441ca.hk.jpg)
...
![顯示信號的折線圖，具有固定間隔的離散點](../../../../../translated_images/sampling.6f4fadb3f2d9dfe7.hk.png)
