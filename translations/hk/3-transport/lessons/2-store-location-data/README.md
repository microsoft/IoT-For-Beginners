...
![將 GPS 遙測數據從 IoT 設備發送到 IoT Hub，然後通過事件觸發器發送到 Azure Functions，最後保存到 Blob 存儲](../../../../../translated_images/hk/save-telemetry-to-storage-from-functions.ed3b1820980097f1.webp)
