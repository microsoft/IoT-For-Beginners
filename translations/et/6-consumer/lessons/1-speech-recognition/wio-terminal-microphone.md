...
![Mikrofon Wio Terminalil](../../../../../translated_images/wio-mic.3f8c843dbe8ad917.et.png)
...
![ReSpeaker 2-Mics Pi Hat](../../../../../translated_images/respeaker.f5d19d1c6b14ab16.et.png)
...
1. Kui Wio Terminal on välja lülitatud, ühenda ReSpeaker 2-Mics Pi Hat Wio Terminaliga, kasutades hüppajakaableid ja GPIO pesasid Wio Terminali tagaküljel:
    ...
    ![Pinide diagramm](../../../../../translated_images/wio-respeaker-wiring-0.767f80aa65081038.et.png)
...
1. Korda seda kogu vasaku külje GPIO pesade ulatuses. Veendu, et pinid oleksid kindlalt paigas.
    ...
    ![ReSpeaker, mille vasakpoolne külg on ühendatud Wio Terminali vasakpoolse küljega](../../../../../translated_images/wio-respeaker-wiring-1.8d894727f2ba2400.et.png)

    ![ReSpeaker, mille vasakpoolne külg on ühendatud Wio Terminali vasakpoolse küljega](../../../../../translated_images/wio-respeaker-wiring-2.329e1cbd306e754f.et.png)
...
1. Korda protsessi, kasutades ReSpeakeri ja Wio Terminali parempoolseid GPIO pesasid. Need kaablid peavad minema juba paigaldatud kaablite ümber.
    ...
    ![ReSpeaker, mille parempoolne külg on ühendatud Wio Terminali parempoolse küljega](../../../../../translated_images/wio-respeaker-wiring-3.75b0be447e2fa930.et.png)

    ![ReSpeaker, mille parempoolne külg on ühendatud Wio Terminali parempoolse küljega](../../../../../translated_images/wio-respeaker-wiring-4.aa9cd434d8779437.et.png)
    ...
    >
    > ![Pinid kinnitatud kleeplindiga](../../../../../translated_images/wio-respeaker-wiring-5.af117c20acf622f3.et.png)

1. Sul on vaja lisada kõlar.

    * Kui kasutad kõlarit JST-kaabliga, ühenda see ReSpeakeri JST-pesasse.

      ![Kõlar ühendatud ReSpeakeriga JST-kaabli abil](../../../../../translated_images/respeaker-jst-speaker.a441d177809df945.et.png)

    * Kui kasutad kõlarit 3,5 mm pistikuga või kõrvaklappe, sisesta need 3,5 mm pistikupessa.

      ![Kõlar ühendatud ReSpeakeriga 3,5 mm pistikupesa kaudu](../../../../../translated_images/respeaker-35mm-speaker.ad79ef4f128c7751.et.png)
...
1. Sisesta SD-kaart Wio Terminali SD-kaardi pesasse, mis asub vasakul küljel, vahetult toitelüliti all. Veendu, et kaart oleks täielikult sees ja klõpsaks paika - sul võib vaja minna õhukest tööriista või teist SD-kaarti, et aidata seda täielikult sisse lükata.
    ...
    ![SD-kaardi sisestamine SD-kaardi pesasse toitelüliti all](../../../../../translated_images/wio-sd-card.acdcbe322fa4ee7f.et.png)
