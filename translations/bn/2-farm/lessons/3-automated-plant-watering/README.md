...
![চালু হলে, ইলেক্ট্রোম্যাগনেট একটি চুম্বকীয় ক্ষেত্র তৈরি করে, আউটপুট সার্কিটের জন্য সুইচ চালু করে](../../../../../translated_images/relay-on.4db16a0fd6b66926.bn.png)
...
![বন্ধ হলে, ইলেক্ট্রোম্যাগনেট একটি চুম্বকীয় ক্ষেত্র তৈরি করে না, আউটপুট সার্কিটের জন্য সুইচ বন্ধ করে](../../../../../translated_images/relay-off.c34a178a2960fecd.bn.png)
...
![একটি রিলের মাধ্যমে তারযুক্ত একটি পাম্প](../../../../../translated_images/pump-wired-to-relay.66c5cfc0d8918990.bn.png)
...
![মাটির আর্দ্রতার একটি পরিমাপ ৬৫৮ দেখাচ্ছে যা পানি দেওয়ার সময় পরিবর্তন হয় না, এটি কেবল ৩২০-এ নেমে আসে যখন পানি মাটির ভেতর দিয়ে শোষিত হয়](../../../../../translated_images/soil-moisture-travel.a0e31af222cf1438.bn.png)
...
![একটি স্ট্রবেরি গাছ একটি পাম্পের মাধ্যমে পানির সাথে সংযুক্ত, পাম্পটি একটি রিলের সাথে সংযুক্ত। রিলে এবং মাটির আর্দ্রতা সেন্সর উভয়ই একটি র‌্যাস্পবেরি পাইয়ের সাথে সংযুক্ত](../../../../../translated_images/strawberry-with-pump.b410fc72ac6aabad.bn.png)
...
![ধাপ ১, পরিমাপ নিন। ধাপ ২, পানি যোগ করুন। ধাপ ৩, পানি মাটির ভেতর দিয়ে শোষিত হওয়ার জন্য অপেক্ষা করুন। ধাপ ৪, পরিমাপ পুনরায় নিন](../../../../../translated_images/soil-moisture-delay.865f3fae206db01d.bn.png)
