...
![রিলেশনাল ডেটাবেস যেখানে ইউজার টেবিলের ID পচases টেবিলের ইউজার ID কলামের সাথে সম্পর্কিত এবং প্রোডাক্ট টেবিলের ID পচases টেবিলের প্রোডাক্ট ID এর সাথে সম্পর্কিত](../../../../../translated_images/sql-database.be160f12bfccefd3.bn.png)
...
![IoT ডিভাইস থেকে GPS টেলিমেট্রি IoT Hub-এ পাঠানো, তারপর Azure Functions-এ ইভেন্ট হাব ট্রিগারের মাধ্যমে, তারপর Blob স্টোরেজে সংরক্ষণ করা](../../../../../translated_images/save-telemetry-to-storage-from-functions.ed3b1820980097f1.bn.png)
