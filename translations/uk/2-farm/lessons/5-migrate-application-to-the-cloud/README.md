...
![Коли багато подій надсилаються одночасно, безсерверний сервіс масштабується для їх одночасного виконання](../../../../../translated_images/uk/serverless-scaling.f8c769adf0413fd1.png)
...
1. Відкрийте поточну папку у VS Code, або запустивши VS Code і відкривши цю папку, або виконавши наступну команду:
    ...
    ![Сповіщення](../../../../../translated_images/uk/vscode-azure-functions-init-notification.bd19b49229963edb.png)
