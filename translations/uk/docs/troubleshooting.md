...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-06T21:49:07+00:00",
  "source_file": "docs/troubleshooting.md",
  "language_code": "uk"
}
-->
# Посібник з усунення несправностей Raspberry Pi

Цей посібник надає рішення для поширених проблем, що виникають під час роботи з IoT-проектами на пристроях Raspberry Pi.  
Він розроблений для початківців, що проходять навчальний курс IoT-For-Beginners, але також корисний для загальної розробки на Pi.

---

## 1. Помилки встановлення та залежностей

### ❗ `ModuleNotFoundError: No module named 'xyz'`
Це відбувається, коли потрібні модулі Python не встановлені.
...
Цей документ було перекладено за допомогою сервісу машинного перекладу [Co-op Translator](https://github.com/Azure/co-op-translator). Хоча ми прагнемо до точності, зверніть увагу, що автоматичні переклади можуть містити помилки або неточності. Оригінальний документ рідною мовою слід вважати офіційним джерелом. Для критично важливої інформації рекомендується звертатися до професійного людського перекладу. Ми не несемо відповідальності за будь-які непорозуміння чи неправильні тлумачення, що виникли внаслідок використання цього перекладу.
