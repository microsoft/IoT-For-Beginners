...
-->
# Khám phá sâu hơn về IoT

![Tóm tắt bài học bằng sketchnote](../../../../../translated_images/lesson-2.324b0580d620c25e0a24fb7fddfc0b29a846dd4b82c08e7a9466d580ee78ce51.vi.jpg)
...
[![Bài học 2: Khám phá sâu hơn về IoT](https://img.youtube.com/vi/t0SySWw3z9M/0.jpg)](https://youtu.be/t0SySWw3z9M)

[![Bài học 2: Khám phá sâu hơn về IoT - Buổi hỏi đáp](https://img.youtube.com/vi/tTZYf9EST1E/0.jpg)](https://youtu.be/tTZYf9EST1E)
...
* [Khám phá sâu hơn về vi điều khiển](../../../../../1-getting-started/lessons/2-deeper-dive)
* [Khám phá sâu hơn về máy tính bảng đơn](../../../../../1-getting-started/lessons/2-deeper-dive)
...
Phần **Thiết bị** trong IoT đề cập đến một thiết bị có khả năng tương tác với thế giới vật lý. Những thiết bị này thường là các máy tính nhỏ, giá rẻ, chạy ở tốc độ thấp và sử dụng ít năng lượng - ví dụ như các vi điều khiển đơn giản với vài kilobyte RAM (so với gigabyte trên PC), chạy chỉ vài trăm megahertz (so với gigahertz trên PC), nhưng tiêu thụ ít năng lượng đến mức có thể hoạt động trong nhiều tuần, tháng hoặc thậm chí nhiều năm chỉ với pin.

Những thiết bị này tương tác với thế giới vật lý, hoặc bằng cách sử dụng cảm biến để thu thập dữ liệu từ môi trường xung quanh, hoặc bằng cách điều khiển đầu ra hoặc bộ truyền động để tạo ra các thay đổi vật lý. Ví dụ điển hình là một bộ điều nhiệt thông minh - một thiết bị có cảm biến nhiệt độ, phương tiện để đặt nhiệt độ mong muốn như núm xoay hoặc màn hình cảm ứng, và kết nối với hệ thống sưởi hoặc làm mát có thể bật khi nhiệt độ được phát hiện nằm ngoài phạm vi mong muốn. Cảm biến nhiệt độ phát hiện rằng phòng quá lạnh và một bộ truyền động sẽ bật hệ thống sưởi.
...
Có rất nhiều loại thiết bị khác nhau có thể hoạt động như thiết bị IoT, từ phần cứng chuyên dụng chỉ cảm nhận một thứ, đến các thiết bị đa năng, thậm chí là điện thoại thông minh của bạn! Điện thoại thông minh có thể sử dụng cảm biến để phát hiện thế giới xung quanh và bộ truyền động để tương tác với thế giới - ví dụ như sử dụng cảm biến GPS để xác định vị trí của bạn và loa để cung cấp hướng dẫn điều hướng đến một điểm đến.

✅ Hãy nghĩ về các hệ thống khác xung quanh bạn có khả năng đọc dữ liệu từ cảm biến và sử dụng dữ liệu đó để đưa ra quyết định. Một ví dụ là bộ điều nhiệt trên lò nướng. Bạn có thể tìm thêm ví dụ không?

### Internet

Phần **Internet** của một ứng dụng IoT bao gồm các ứng dụng mà thiết bị IoT có thể kết nối để gửi và nhận dữ liệu, cũng như các ứng dụng khác có thể xử lý dữ liệu từ thiết bị IoT và hỗ trợ đưa ra quyết định về các yêu cầu gửi đến bộ truyền động của thiết bị IoT.
...
Các thiết bị cũng không phải lúc nào cũng kết nối trực tiếp với Internet qua WiFi hoặc kết nối có dây. Một số thiết bị sử dụng mạng lưới để giao tiếp với nhau qua các công nghệ như Bluetooth, kết nối thông qua một thiết bị trung tâm có kết nối Internet.

Với ví dụ về bộ điều nhiệt thông minh, bộ điều nhiệt sẽ kết nối qua WiFi gia đình với một dịch vụ đám mây chạy trên đám mây. Nó sẽ gửi dữ liệu nhiệt độ đến dịch vụ đám mây này, và từ đó dữ liệu sẽ được ghi vào một cơ sở dữ liệu nào đó cho phép chủ nhà kiểm tra nhiệt độ hiện tại và quá khứ thông qua ứng dụng điện thoại. Một dịch vụ khác trên đám mây sẽ biết nhiệt độ mà chủ nhà mong muốn, và gửi tin nhắn trở lại thiết bị IoT thông qua dịch vụ đám mây để điều khiển hệ thống sưởi bật hoặc tắt.

![Sơ đồ hiển thị nhiệt độ và núm xoay làm đầu vào cho thiết bị IoT, thiết bị IoT có giao tiếp hai chiều với đám mây, đám mây có giao tiếp hai chiều với điện thoại, và điều khiển hệ thống sưởi làm đầu ra từ thiết bị IoT](../../../../../translated_images/mobile-controlled-thermostat.4a994010473d8d6a52ba68c67e5f02dc8928c717e93ca4b9bc55525aa75bbb60.vi.png)

Phiên bản thông minh hơn có thể sử dụng AI trên đám mây với dữ liệu từ các cảm biến khác kết nối với các thiết bị IoT khác như cảm biến phát hiện phòng nào đang được sử dụng, cũng như dữ liệu như thời tiết và thậm chí là lịch của bạn, để đưa ra quyết định về cách đặt nhiệt độ một cách thông minh. Ví dụ, nó có thể tắt hệ thống sưởi nếu đọc từ lịch của bạn rằng bạn đang đi nghỉ, hoặc tắt hệ thống sưởi theo từng phòng tùy thuộc vào phòng nào bạn sử dụng, học hỏi từ dữ liệu để ngày càng chính xác hơn theo thời gian.
...
Mặc dù chữ I trong IoT là viết tắt của Internet, các thiết bị này không nhất thiết phải kết nối với Internet. Trong một số trường hợp, các thiết bị có thể kết nối với các thiết bị 'biên' - các thiết bị cổng chạy trên mạng nội bộ của bạn, cho phép xử lý dữ liệu mà không cần gọi qua Internet. Điều này có thể nhanh hơn khi bạn có nhiều dữ liệu hoặc kết nối Internet chậm, cho phép bạn hoạt động ngoại tuyến khi không thể kết nối Internet như trên tàu hoặc trong khu vực thảm họa khi ứng phó với khủng hoảng nhân đạo, và cho phép bạn giữ dữ liệu riêng tư. Một số thiết bị sẽ chứa mã xử lý được tạo bằng các công cụ đám mây và chạy mã này cục bộ để thu thập và phản hồi dữ liệu mà không cần sử dụng kết nối Internet để đưa ra quyết định.

Một ví dụ về điều này là thiết bị nhà thông minh như Apple HomePod, Amazon Alexa, hoặc Google Home, sẽ lắng nghe giọng nói của bạn bằng các mô hình AI được huấn luyện trên đám mây, nhưng chạy cục bộ trên thiết bị. Những thiết bị này sẽ 'thức dậy' khi một từ hoặc cụm từ nhất định được nói, và chỉ sau đó gửi giọng nói của bạn qua Internet để xử lý. Thiết bị sẽ ngừng gửi giọng nói tại một thời điểm thích hợp như khi phát hiện một khoảng dừng trong lời nói của bạn. Mọi thứ bạn nói trước khi đánh thức thiết bị bằng từ đánh thức, và mọi thứ bạn nói sau khi thiết bị đã ngừng lắng nghe sẽ không được gửi qua Internet đến nhà cung cấp thiết bị, và do đó sẽ được giữ riêng tư.

✅ Hãy nghĩ về các tình huống khác mà quyền riêng tư là quan trọng, vì vậy việc xử lý dữ liệu sẽ tốt hơn nếu được thực hiện tại biên thay vì trên đám mây. Gợi ý - hãy nghĩ về các thiết bị IoT có camera hoặc các thiết bị hình ảnh khác.

### Bảo mật IoT

Với bất kỳ kết nối Internet nào, bảo mật là một yếu tố quan trọng cần cân nhắc. Có một câu nói đùa rằng 'chữ S trong IoT là viết tắt của Security' - không có chữ 'S' trong IoT, ngụ ý rằng nó không an toàn.

Các thiết bị IoT kết nối với một dịch vụ đám mây, và do đó chỉ an toàn như dịch vụ đám mây đó - nếu dịch vụ đám mây của bạn cho phép bất kỳ thiết bị nào kết nối thì dữ liệu độc hại có thể được gửi, hoặc các cuộc tấn công virus có thể xảy ra. Điều này có thể có hậu quả rất thực tế vì các thiết bị IoT tương tác và điều khiển các thiết bị khác. Ví dụ, [sâu Stuxnet](https://wikipedia.org/wiki/Stuxnet) đã thao túng các van trong máy ly tâm để làm hỏng chúng. Tin tặc cũng đã lợi dụng [bảo mật kém để truy cập vào các thiết bị giám sát trẻ em](https://www.npr.org/sections/thetwo-way/2018/06/05/617196788/s-c-mom-says-baby-monitor-was-hacked-experts-say-many-devices-are-vulnerable) và các thiết bị giám sát gia đình khác.

> 💁 Đôi khi các thiết bị IoT và thiết bị biên chạy trên một mạng hoàn toàn cách ly khỏi Internet để giữ dữ liệu riêng tư và an toàn. Điều này được gọi là [air-gapping](https://wikipedia.org/wiki/Air_gap_(networking)).

## Khám phá sâu hơn về vi điều khiển

Trong bài học trước, chúng ta đã giới thiệu về vi điều khiển. Bây giờ hãy cùng tìm hiểu sâu hơn về chúng.

### CPU

CPU là 'bộ não' của vi điều khiển. Đây là bộ xử lý chạy mã của bạn và có thể gửi dữ liệu đến và nhận dữ liệu từ bất kỳ thiết bị nào được kết nối. CPU có thể chứa một hoặc nhiều lõi - về cơ bản là một hoặc nhiều CPU có thể làm việc cùng nhau để chạy mã của bạn.

CPU dựa vào một đồng hồ để đánh dấu hàng triệu hoặc hàng tỷ lần mỗi giây. Mỗi lần đánh dấu, hoặc chu kỳ, đồng bộ hóa các hành động mà CPU có thể thực hiện. Với mỗi lần đánh dấu, CPU có thể thực hiện một lệnh từ chương trình, chẳng hạn như lấy dữ liệu từ một thiết bị bên ngoài hoặc thực hiện một phép tính toán học. Chu kỳ đều đặn này cho phép tất cả các hành động được hoàn thành trước khi lệnh tiếp theo được xử lý.

Tốc độ chu kỳ đồng hồ càng nhanh, càng nhiều lệnh có thể được xử lý mỗi giây, và do đó CPU càng nhanh. Tốc độ CPU được đo bằng [Hertz (Hz)](https://wikipedia.org/wiki/Hertz), một đơn vị tiêu chuẩn mà 1 Hz nghĩa là một chu kỳ hoặc đánh dấu đồng hồ mỗi giây.

> 🎓 Tốc độ CPU thường được đưa ra bằng MHz hoặc GHz. 1MHz là 1 triệu Hz, 1GHz là 1 tỷ Hz.

> 💁 CPU thực hiện chương trình bằng [chu kỳ lấy-dịch-thực thi](https://wikipedia.org/wiki/Instruction_cycle). Với mỗi lần đánh dấu đồng hồ, CPU sẽ lấy lệnh tiếp theo từ bộ nhớ, dịch nó, sau đó thực thi nó như sử dụng đơn vị logic số học (ALU) để cộng 2 số. Một số lệnh thực thi sẽ mất nhiều lần đánh dấu để chạy, vì vậy chu kỳ tiếp theo sẽ chạy vào lần đánh dấu tiếp theo sau khi lệnh đã hoàn thành.

![Chu kỳ lấy-dịch-thực thi hiển thị việc lấy lệnh từ chương trình được lưu trữ trong RAM, sau đó dịch và thực thi nó trên CPU](../../../../../translated_images/fetch-decode-execute.2fd6f150f6280392807f4475382319abd0cee0b90058e1735444d6baa6f2078c.vi.png)
...
Bộ nhớ chương trình là không bay hơi, nghĩa là bất cứ thứ gì được ghi vào nó sẽ vẫn còn khi không có nguồn điện cho thiết bị. Đây là bộ nhớ lưu trữ mã chương trình của bạn.

RAM là bộ nhớ được chương trình sử dụng để chạy, chứa các biến được cấp phát bởi chương trình của bạn và dữ liệu thu thập từ các thiết bị ngoại vi. RAM là bay hơi, khi mất nguồn điện nội dung sẽ bị mất, về cơ bản là đặt lại chương trình của bạn.
...
Giống như CPU, bộ nhớ trên vi điều khiển nhỏ hơn rất nhiều so với PC hoặc Mac. Một PC thông thường có thể có 8 Gigabyte (GB) RAM, tương đương 8.000.000.000 byte, với mỗi byte đủ để lưu trữ một chữ cái hoặc một số từ 0-255. Một vi điều khiển thường chỉ có Kilobyte (KB) RAM, với một kilobyte là 1.000 byte. Wio Terminal được đề cập ở trên có 192KB RAM, tương đương 192.000 byte - ít hơn hơn 40.000 lần so với một PC trung bình!

Biểu đồ dưới đây cho thấy sự khác biệt về kích thước tương đối giữa 192KB và 8GB - chấm nhỏ ở trung tâm đại diện cho 192KB.
...
Vi điều khiển cần các kết nối đầu vào và đầu ra (I/O) để đọc dữ liệu từ cảm biến và gửi tín hiệu điều khiển đến các bộ truyền động. Chúng thường chứa một số chân đầu vào/đầu ra đa dụng (GPIO). Các chân này có thể được cấu hình trong phần mềm để làm đầu vào (tức là nhận tín hiệu) hoặc đầu ra (gửi tín hiệu).

🧠⬅️ Các chân đầu vào được sử dụng để đọc giá trị từ cảm biến

🧠➡️ Các chân đầu ra gửi hướng dẫn đến bộ truyền động

✅ Bạn sẽ học thêm về điều này trong bài học tiếp theo.
...
✅ Tìm hiểu thêm về một số RTOS: [Azure RTOS](https://azure.microsoft.com/services/rtos/?WT.mc_id=academic-17441-jabenn), [FreeRTOS](https://www.freertos.org), [Zephyr](https://www.zephyrproject.org)
...
Có một hệ sinh thái lớn các thư viện Arduino của bên thứ ba cho phép bạn thêm các tính năng bổ sung vào các dự án Arduino của mình, chẳng hạn như sử dụng cảm biến và bộ truyền động hoặc kết nối với các dịch vụ IoT trên đám mây.

##### Nhiệm vụ

Khám phá Wio Terminal.

Nếu bạn đang sử dụng Wio Terminal cho các bài học này, hãy đọc lại mã bạn đã viết trong bài học trước. Tìm hàm `setup` và `loop`. Theo dõi đầu ra serial để xem hàm loop được gọi liên tục. Thử thêm mã vào hàm `setup` để ghi vào cổng serial và quan sát rằng mã này chỉ được gọi một lần mỗi khi bạn khởi động lại. Thử khởi động lại thiết bị của bạn bằng công tắc nguồn ở bên cạnh để xem mã này được gọi mỗi lần thiết bị khởi động lại.

## Tìm hiểu sâu hơn về máy tính bảng đơn

Trong bài học trước, chúng ta đã giới thiệu về máy tính bảng đơn. Bây giờ hãy tìm hiểu sâu hơn về chúng.
...
[Raspberry Pi Foundation](https://www.raspberrypi.org) là một tổ chức từ thiện từ Vương quốc Anh được thành lập vào năm 2009 để thúc đẩy việc học tập khoa học máy tính, đặc biệt ở cấp độ trường học. Là một phần của sứ mệnh này, họ đã phát triển một máy tính bảng đơn, gọi là Raspberry Pi. Raspberry Pi hiện có sẵn trong 3 biến thể - phiên bản đầy đủ kích thước, phiên bản nhỏ hơn Pi Zero, và một module tính toán có thể được tích hợp vào thiết bị IoT cuối cùng của bạn.

![Raspberry Pi 4](../../../../../translated_images/raspberry-pi-4.fd4590d308c3d456db1327e86b395ddcd735513267aafd4879ea2785f7792eac.vi.jpg)

Phiên bản mới nhất của Raspberry Pi đầy đủ kích thước là Raspberry Pi 4B. Nó có CPU bốn lõi (4 lõi) chạy ở tốc độ 1.5GHz, RAM 2, 4 hoặc 8GB, ethernet gigabit, WiFi, 2 cổng HDMI hỗ trợ màn hình 4k, một cổng âm thanh và video composite, các cổng USB (2 USB 2.0, 2 USB 3.0), 40 chân GPIO, một cổng kết nối camera cho module camera Raspberry Pi, và một khe cắm thẻ SD. Tất cả điều này trên một bo mạch có kích thước 88mm x 58mm x 19.5mm và được cấp nguồn bởi nguồn USB-C 3A. Giá khởi điểm là 35 USD, rẻ hơn nhiều so với PC hoặc Mac.
...
> 🎓 CPU trong cả hai đều là bộ xử lý ARM, khác với bộ xử lý Intel/AMD x86 hoặc x64 mà bạn tìm thấy trong hầu hết các PC và Mac. Chúng tương tự như CPU bạn tìm thấy trong một số vi điều khiển, cũng như gần như tất cả điện thoại di động, Microsoft Surface X, và các máy Mac mới dựa trên Apple Silicon.
...
* Bạn có thể tìm thấy chi tiết về các bộ xử lý được sử dụng trên [trang tài liệu phần cứng Raspberry Pi](https://www.raspberrypi.org/documentation/hardware/raspberrypi/). Tìm hiểu về bộ xử lý được sử dụng trong Pi mà bạn đang sử dụng.
...
### Lập trình máy tính bảng đơn

Máy tính bảng đơn là máy tính đầy đủ, chạy một hệ điều hành đầy đủ. Điều này có nghĩa là có một loạt các ngôn ngữ lập trình, framework và công cụ bạn có thể sử dụng để lập trình chúng, không giống như vi điều khiển phụ thuộc vào hỗ trợ cho bo mạch trong các framework như Arduino. Hầu hết các ngôn ngữ lập trình đều có thư viện có thể truy cập các chân GPIO để gửi và nhận dữ liệu từ cảm biến và bộ truyền động.
