...
![Tóm tắt bài học dưới dạng sketchnote](../../../../../translated_images/lesson-3.cc3b7b4cd646de598698cce043c0393fd62ef42bac2eaf60e61272cd844250f4.vi.jpg)

> Sketchnote bởi [Nitya Narasimhan](https://github.com/nitya). Nhấn vào hình ảnh để xem phiên bản lớn hơn.

Bài học này được giảng dạy trong chuỗi [Hello IoT](https://youtube.com/playlist?list=PLmsFUfdnGr3xRts0TIwyaHyQuHaNQcb6-) từ [Microsoft Reactor](https://developer.microsoft.com/reactor/?WT.mc_id=academic-17441-jabenn). Bài học được chia thành 2 video - một bài giảng dài 1 giờ và một buổi hỏi đáp dài 1 giờ để đi sâu hơn vào các phần của bài học và trả lời câu hỏi.
...
[Câu hỏi trước bài học](https://black-meadow-040d15503.1.azurestaticapps.net/quiz/5)
...
* Cảm biến nhiệt độ - cảm nhận nhiệt độ không khí hoặc nhiệt độ của vật mà chúng tiếp xúc. Đối với người dùng phổ thông và nhà phát triển, các cảm biến này thường được kết hợp với cảm biến áp suất không khí và độ ẩm trong một thiết bị duy nhất.
* Nút bấm - cảm nhận khi chúng được nhấn.
* Cảm biến ánh sáng - phát hiện mức độ ánh sáng và có thể dành cho các màu cụ thể, ánh sáng UV, ánh sáng hồng ngoại, hoặc ánh sáng nhìn thấy chung.
...
✅ Hãy nghiên cứu. Điện thoại của bạn có những cảm biến nào?

Tất cả các cảm biến đều có một điểm chung - chúng chuyển đổi những gì chúng cảm nhận thành tín hiệu điện có thể được thiết bị IoT giải mã. Cách tín hiệu điện này được giải mã phụ thuộc vào cảm biến, cũng như giao thức truyền thông được sử dụng để giao tiếp với thiết bị IoT.
...
* [Máy tính đơn bo - Raspberry Pi](pi-sensor.md)
* [Máy tính đơn bo - Thiết bị ảo](virtual-device-sensor.md)

## Các loại cảm biến

Cảm biến có thể là cảm biến tương tự hoặc cảm biến số.

### Cảm biến tương tự

Một số cảm biến cơ bản nhất là cảm biến tương tự. Các cảm biến này nhận một điện áp từ thiết bị IoT, các thành phần của cảm biến điều chỉnh điện áp này, và điện áp trả về từ cảm biến được đo để đưa ra giá trị cảm biến.

> 🎓 Điện áp là thước đo mức độ "đẩy" để di chuyển dòng điện từ nơi này đến nơi khác, chẳng hạn từ cực dương của pin đến cực âm. Ví dụ, một pin AA tiêu chuẩn có điện áp 1,5V (V là ký hiệu của volt) và có thể đẩy dòng điện với lực 1,5V từ cực dương đến cực âm. Các phần cứng điện khác nhau yêu cầu các điện áp khác nhau để hoạt động, ví dụ, một đèn LED có thể sáng với điện áp từ 2-3V, nhưng một bóng đèn sợi đốt 100W sẽ cần 240V. Bạn có thể đọc thêm về điện áp trên [trang Wikipedia về điện áp](https://wikipedia.org/wiki/Voltage).
...
Thiết bị IoT sẽ gửi một tín hiệu điện đến chiết áp với một điện áp, chẳng hạn 5 volt (5V). Khi chiết áp được điều chỉnh, nó thay đổi điện áp đầu ra. Hãy tưởng tượng bạn có một chiết áp được đánh dấu như một núm xoay từ 0 đến [11](https://wikipedia.org/wiki/Up_to_eleven), chẳng hạn như núm điều chỉnh âm lượng trên một bộ khuếch đại. Khi chiết áp ở vị trí tắt hoàn toàn (0), thì 0V (0 volt) sẽ được trả về. Khi nó ở vị trí bật hoàn toàn (11), 5V (5 volt) sẽ được trả về.
...
Điện áp trả về từ cảm biến sau đó được thiết bị IoT đọc, và thiết bị có thể phản hồi lại. Tùy thuộc vào cảm biến, điện áp này có thể là một giá trị bất kỳ hoặc có thể được ánh xạ thành một đơn vị tiêu chuẩn. Ví dụ, một cảm biến nhiệt độ tương tự dựa trên [thermistor](https://wikipedia.org/wiki/Thermistor) thay đổi điện trở của nó tùy thuộc vào nhiệt độ. Điện áp đầu ra sau đó có thể được chuyển đổi thành nhiệt độ theo Kelvin, và tương ứng thành °C hoặc °F, thông qua các phép tính trong mã.

✅ Bạn nghĩ điều gì sẽ xảy ra nếu cảm biến trả về một điện áp cao hơn điện áp được gửi (ví dụ đến từ một nguồn điện bên ngoài)? ⛔️ KHÔNG thử nghiệm điều này.

#### Chuyển đổi từ tương tự sang số

Thiết bị IoT là kỹ thuật số - chúng không thể làm việc với các giá trị tương tự, chúng chỉ làm việc với 0 và 1. Điều này có nghĩa là các giá trị cảm biến tương tự cần được chuyển đổi thành tín hiệu số trước khi chúng có thể được xử lý. Nhiều thiết bị IoT có bộ chuyển đổi tương tự-sang-số (ADC) để chuyển đổi các đầu vào tương tự thành các biểu diễn số của giá trị đó. Cảm biến cũng có thể làm việc với ADC thông qua một bảng kết nối. Ví dụ, trong hệ sinh thái Seeed Grove với Raspberry Pi, các cảm biến tương tự kết nối với các cổng cụ thể trên một 'hat' được gắn trên Pi, kết nối với các chân GPIO của Pi, và 'hat' này có một ADC để chuyển đổi điện áp thành tín hiệu số có thể được gửi qua các chân GPIO của Pi.

Hãy tưởng tượng bạn có một cảm biến ánh sáng tương tự được kết nối với một thiết bị IoT sử dụng 3,3V và trả về giá trị 1V. Giá trị 1V này không có ý nghĩa gì trong thế giới số, vì vậy cần được chuyển đổi. Điện áp sẽ được chuyển đổi thành giá trị tương tự sử dụng một thang đo tùy thuộc vào thiết bị và cảm biến. Một ví dụ là cảm biến ánh sáng Seeed Grove, cảm biến này xuất giá trị từ 0 đến 1.023. Với cảm biến này chạy ở 3,3V, một đầu ra 1V sẽ là giá trị 300. Một thiết bị IoT không thể xử lý 300 như một giá trị tương tự, vì vậy giá trị này sẽ được chuyển đổi thành `0000000100101100`, biểu diễn nhị phân của 300 bởi Grove hat. Giá trị này sau đó sẽ được thiết bị IoT xử lý.

✅ Nếu bạn chưa biết về hệ nhị phân, hãy nghiên cứu một chút để tìm hiểu cách các con số được biểu diễn bằng 0 và 1. [Bài học giới thiệu về hệ nhị phân của BBC Bitesize](https://www.bbc.co.uk/bitesize/guides/zwsbwmn/revision/1) là một nơi tuyệt vời để bắt đầu.

Từ góc độ lập trình, tất cả điều này thường được xử lý bởi các thư viện đi kèm với cảm biến, vì vậy bạn không cần phải lo lắng về việc chuyển đổi này. Với cảm biến ánh sáng Grove, bạn sẽ sử dụng thư viện Python và gọi thuộc tính `light`, hoặc sử dụng thư viện Arduino và gọi `analogRead` để nhận giá trị 300.

### Cảm biến số

Cảm biến số, giống như cảm biến tương tự, phát hiện thế giới xung quanh bằng cách sử dụng sự thay đổi điện áp. Điểm khác biệt là chúng xuất tín hiệu số, hoặc chỉ đo hai trạng thái hoặc sử dụng ADC tích hợp. Cảm biến số ngày càng trở nên phổ biến để tránh việc phải sử dụng ADC trong bảng kết nối hoặc trên chính thiết bị IoT.

Cảm biến số đơn giản nhất là nút bấm hoặc công tắc. Đây là cảm biến với hai trạng thái, bật hoặc tắt.
...
Các chân trên thiết bị IoT như chân GPIO có thể đo tín hiệu này trực tiếp dưới dạng 0 hoặc 1. Nếu điện áp gửi đi giống với điện áp trả về, giá trị đọc được là 1, nếu không giá trị đọc được là 0. Không cần phải chuyển đổi tín hiệu, nó chỉ có thể là 1 hoặc 0.

> 💁 Điện áp không bao giờ chính xác hoàn toàn, đặc biệt khi các thành phần trong cảm biến có một số điện trở, vì vậy thường có một mức dung sai. Ví dụ, các chân GPIO trên Raspberry Pi hoạt động ở 3,3V, và đọc tín hiệu trả về trên 1,8V là 1, dưới 1,8V là 0.

* 3,3V đi vào nút bấm. Nút bấm tắt nên 0V được trả về, cho giá trị 0.
* 3,3V đi vào nút bấm. Nút bấm bật nên 3,3V được trả về, cho giá trị 1.

Các cảm biến số tiên tiến hơn đọc các giá trị tương tự, sau đó chuyển đổi chúng bằng ADC tích hợp thành tín hiệu số. Ví dụ, một cảm biến nhiệt độ số vẫn sử dụng một cặp nhiệt điện giống như cảm biến tương tự, và vẫn đo sự thay đổi điện áp gây ra bởi điện trở của cặp nhiệt điện ở nhiệt độ hiện tại. Thay vì trả về giá trị tương tự và dựa vào thiết bị hoặc bảng kết nối để chuyển đổi thành tín hiệu số, một ADC tích hợp trong cảm biến sẽ chuyển đổi giá trị và gửi nó dưới dạng một chuỗi 0 và 1 đến thiết bị IoT. Những 0 và 1 này được gửi theo cách giống như tín hiệu số cho một nút bấm với 1 là điện áp đầy đủ và 0 là 0V.

![Một cảm biến nhiệt độ số chuyển đổi giá trị tương tự thành dữ liệu nhị phân với 0 là 0 volt và 1 là 5 volt trước khi gửi đến thiết bị IoT](../../../../../translated_images/temperature-as-digital.85004491b977bae1129707df107c0b19fe6fc6374210e9027e04acb34a640c78.vi.png)

Việc gửi dữ liệu số cho phép cảm biến trở nên phức tạp hơn và gửi dữ liệu chi tiết hơn, thậm chí là dữ liệu được mã hóa cho các cảm biến bảo mật. Một ví dụ là camera. Đây là một cảm biến chụp ảnh và gửi nó dưới dạng dữ liệu số chứa hình ảnh đó, thường ở định dạng nén như JPEG, để được thiết bị IoT đọc. Nó thậm chí có thể truyền video bằng cách chụp ảnh và gửi hoặc toàn bộ khung hình từng khung hoặc một luồng video nén.
...
* Đèn LED - phát sáng khi được bật
* Loa - phát âm thanh dựa trên tín hiệu gửi đến, từ tiếng bíp cơ bản đến loa âm thanh có thể phát nhạc
...
* Màn hình - là các bộ truyền động phức tạp hơn và hiển thị thông tin trên màn hình nhiều đoạn. Màn hình có thể từ các màn hình LED đơn giản đến các màn hình video độ phân giải cao.

✅ Hãy nghiên cứu. Điện thoại của bạn có những bộ truyền động nào?
...
![Sơ đồ luồng của bài tập cho thấy mức ánh sáng được đọc và kiểm tra, và đèn LED được điều khiển](../../../../../translated_images/assignment-1-flow.7552a51acb1a5ec858dca6e855cdbb44206434006df8ba3799a25afcdab1665d.vi.png)

* [Arduino - Wio Terminal](wio-terminal-actuator.md)
* [Máy tính đơn bo - Raspberry Pi](pi-actuator.md)
* [Máy tính đơn bo - Thiết bị ảo](virtual-device-actuator.md)

## Các loại bộ truyền động

Giống như cảm biến, bộ truyền động có thể là tương tự hoặc số.

### Bộ truyền động tương tự

Bộ truyền động tương tự nhận tín hiệu tương tự và chuyển đổi nó thành một loại tương tác nào đó, trong đó tương tác thay đổi dựa trên điện áp được cung cấp.

Một ví dụ là đèn có thể điều chỉnh độ sáng, chẳng hạn như những chiếc đèn bạn có thể có trong nhà. Lượng điện áp cung cấp cho đèn quyết định độ sáng của nó.
...
Một lựa chọn khác để chuyển đổi tín hiệu số từ thiết bị IoT sang tín hiệu analog là điều chế độ rộng xung (PWM). Điều này liên quan đến việc gửi nhiều xung số ngắn hoạt động như một tín hiệu analog.
...
![Điều chế độ rộng xung quay động cơ ở tốc độ 150 RPM](../../../../../translated_images/pwm-motor-150rpm.83347ac04ca38482bd120939b133803963c9c15ca9d8d484712a4bd92820f6a4.vi.png)
...
✅ Làm thế nào để bạn giữ cho động cơ quay mượt mà, đặc biệt ở tốc độ thấp? Bạn sẽ sử dụng một số lượng nhỏ các xung dài với các khoảng tạm dừng dài hay nhiều xung rất ngắn với các khoảng tạm dừng rất ngắn?
