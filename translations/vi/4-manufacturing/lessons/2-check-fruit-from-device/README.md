...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T22:57:11+00:00",
...
Trong bài học trước, bạn đã tìm hiểu về bộ phân loại hình ảnh và cách huấn luyện chúng để phát hiện trái cây tốt và xấu. Để sử dụng bộ phân loại hình ảnh này trong một ứng dụng IoT, bạn cần có khả năng chụp hình ảnh bằng một loại camera nào đó và gửi hình ảnh này lên đám mây để được phân loại.
...
> 💁 Ống kính đảo ngược hình ảnh, sau đó cảm biến camera lật hình ảnh lại đúng chiều. Điều này cũng giống như trong mắt bạn - những gì bạn nhìn thấy được phát hiện ngược trên mặt sau của mắt và não của bạn sẽ điều chỉnh lại.
...
Khi bạn hài lòng với một lần lặp, bạn có thể xuất bản nó để làm cho nó có sẵn để sử dụng từ các ứng dụng bên ngoài. Bằng cách này, bạn có thể có một phiên bản đã xuất bản được sử dụng bởi các thiết bị của bạn, sau đó làm việc trên một phiên bản mới qua nhiều lần lặp, sau đó xuất bản phiên bản đó khi bạn hài lòng với nó.
...
✅ Khi một lần lặp mới được xuất bản, nó sẽ có một tên khác. Làm thế nào bạn nghĩ rằng bạn sẽ thay đổi lần lặp mà thiết bị IoT đang sử dụng?
...
Để có kết quả tốt nhất cho bộ phân loại hình ảnh, bạn muốn huấn luyện mô hình với các hình ảnh giống với hình ảnh được sử dụng để dự đoán càng nhiều càng tốt. Nếu bạn sử dụng camera điện thoại của mình để chụp hình ảnh cho việc huấn luyện, ví dụ, chất lượng hình ảnh, độ sắc nét và màu sắc sẽ khác với camera kết nối với thiết bị IoT.

![2 hình ảnh quả chuối, một hình ảnh độ phân giải thấp với ánh sáng kém từ thiết bị IoT, và một hình ảnh độ phân giải cao với ánh sáng tốt từ điện thoại](../../../../../translated_images/banana-picture-compare.174df164dc326a42cf7fb051a7497e6113c620e91552d92ca914220305d47d9a.vi.png)
...
Để cải thiện mô hình, bạn có thể huấn luyện lại nó bằng các hình ảnh được chụp từ thiết bị IoT.

### Nhiệm vụ - cải thiện mô hình

1. Phân loại nhiều hình ảnh của cả trái cây chín và chưa chín bằng thiết bị IoT của bạn.

1. Trong cổng Custom Vision, huấn luyện lại mô hình bằng các hình ảnh trên tab *Dự đoán*.
...
1. Huấn luyện một lần lặp mới của mô hình và xuất bản nó bằng các bước trên.
...
Độ phân giải hình ảnh hoặc ánh sáng ảnh hưởng như thế nào đến dự đoán?
...
Nếu bạn tạo một thiết bị sản xuất để bán cho các trang trại hoặc nhà máy, làm thế nào bạn đảm bảo nó luôn cho kết quả nhất quán?
...
Bạn đã huấn luyện mô hình Custom Vision của mình bằng cổng. Điều này dựa vào việc có sẵn hình ảnh - và trong thực tế, bạn có thể không thể có dữ liệu huấn luyện phù hợp với những gì camera trên thiết bị của bạn chụp. Bạn có thể giải quyết vấn đề này bằng cách huấn luyện trực tiếp từ thiết bị của mình bằng API huấn luyện, để huấn luyện mô hình bằng hình ảnh được chụp từ thiết bị IoT của bạn.
