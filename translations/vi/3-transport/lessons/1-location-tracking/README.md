...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T23:45:50+00:00",
...
![Tóm tắt bài học bằng hình minh họa](../../../../../translated_images/lesson-11.9fddbac4b664c6d50ab7ac9bb32f1fc3f945f03760e72f7f43938073762fb017.vi.jpg)

> Hình minh họa bởi [Nitya Narasimhan](https://github.com/nitya). Nhấp vào hình để xem phiên bản lớn hơn.
...
* Theo dõi vị trí - bạn có thể xác định vị trí của một xe bất kỳ lúc nào, cho phép bạn:
  ...
  * Tuân thủ thuế. Một số quốc gia tính phí xe dựa trên số km đã đi trên đường công cộng (như [RUC của New Zealand](https://www.nzta.govt.nz/vehicles/licensing-rego/road-user-charges/)), vì vậy việc biết khi nào xe đang trên đường công cộng so với đường riêng giúp dễ dàng tính thuế phải trả.
...
* Tuân thủ giờ lái xe - đảm bảo tài xế chỉ lái xe trong giờ làm việc hợp pháp dựa trên thời gian họ bật và tắt động cơ.

Những lợi ích này có thể được kết hợp - ví dụ, kết hợp tuân thủ giờ lái xe với theo dõi vị trí để thay đổi tuyến đường của tài xế nếu họ không thể đến đích trong giờ lái xe cho phép. Những lợi ích này cũng có thể được kết hợp với các dữ liệu cảm biến cụ thể của xe khác, chẳng hạn như dữ liệu nhiệt độ từ xe tải kiểm soát nhiệt độ, cho phép xe được thay đổi tuyến đường nếu tuyến đường hiện tại của chúng có thể khiến hàng hóa không được giữ ở nhiệt độ phù hợp.
...
Vĩ độ được đo bằng các đường vòng quanh Trái Đất và chạy song song với xích đạo, chia Bắc Bán Cầu và Nam Bán Cầu thành mỗi bên 90°. Xích đạo ở 0°, Bắc Cực ở 90°, còn được gọi là 90° Bắc, và Nam Cực ở -90°, hoặc 90° Nam.
...
Kinh độ và vĩ độ được đo bằng độ, phút và giây, với một phút bằng 1/60 độ, và 1 giây bằng 1/60 phút.
...
Máy tính không hoạt động theo cơ số-60, vì vậy các tọa độ này được đưa ra dưới dạng độ thập phân khi sử dụng dữ liệu GPS trong hầu hết các hệ thống máy tính. Ví dụ, 2°17'43" là 2.295277. Ký hiệu độ thường bị lược bỏ.

Tọa độ cho một điểm luôn được đưa ra dưới dạng `vĩ độ, kinh độ`, vì vậy ví dụ trước đó về Khuôn viên Microsoft tại 47.6423109,-122.117198 có:
...
> 💁 Tiêu chuẩn này là độc quyền và có giá ít nhất 2.000 USD, nhưng đủ thông tin về nó đã được công khai để hầu hết tiêu chuẩn này đã được giải mã ngược và có thể được sử dụng trong mã nguồn mở và các mã phi thương mại khác.
...
Tự viết trình giải mã NMEA của riêng bạn! Thay vì dựa vào các thư viện của bên thứ ba để giải mã các câu NMEA, bạn có thể tự viết trình giải mã để trích xuất vĩ độ và kinh độ từ các câu NMEA không?

## Câu hỏi sau bài giảng

[Câu hỏi sau bài giảng](https://black-meadow-040d15503.1.azurestaticapps.net/quiz/22)
