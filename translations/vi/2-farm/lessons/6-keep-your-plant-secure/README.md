...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-28T01:24:48+00:00",
  "source_file": "2-farm/lessons/6-keep-your-plant-secure/README.md",
  "language_code": "vi"
}
-->
# Giữ cho cây trồng của bạn an toàn

![Tóm tắt bài học bằng hình vẽ](../../../../../translated_images/lesson-10.829c86b80b9403bb770929ee553a1d293afe50dc23121aaf9be144673ae012cc.vi.jpg)

> Hình vẽ minh họa bởi [Nitya Narasimhan](https://github.com/nitya). Nhấp vào hình ảnh để xem phiên bản lớn hơn.
...
Trong những bài học trước, bạn đã tạo một thiết bị IoT giám sát độ ẩm đất và kết nối nó với đám mây. Nhưng điều gì sẽ xảy ra nếu hacker làm việc cho một nông dân đối thủ chiếm quyền kiểm soát thiết bị IoT của bạn? Điều gì sẽ xảy ra nếu họ gửi các số liệu độ ẩm đất cao giả mạo để cây của bạn không bao giờ được tưới, hoặc bật hệ thống tưới nước liên tục khiến cây chết vì ngập úng và làm bạn tốn một khoản tiền lớn cho nước?

Trong bài học này, bạn sẽ học cách bảo mật các thiết bị IoT. Vì đây là bài học cuối cùng của dự án này, bạn cũng sẽ học cách dọn dẹp các tài nguyên đám mây của mình, giảm thiểu chi phí tiềm năng.
...
Bảo mật IoT liên quan đến việc đảm bảo rằng chỉ các thiết bị được mong đợi mới có thể kết nối với dịch vụ IoT đám mây của bạn và gửi dữ liệu, và chỉ dịch vụ đám mây của bạn mới có thể gửi lệnh đến các thiết bị của bạn. Dữ liệu IoT cũng có thể mang tính cá nhân, bao gồm dữ liệu y tế hoặc nhạy cảm, vì vậy toàn bộ ứng dụng của bạn cần xem xét bảo mật để ngăn chặn việc rò rỉ dữ liệu này.

Nếu ứng dụng IoT của bạn không được bảo mật, có một số rủi ro:

* Một thiết bị giả mạo có thể gửi dữ liệu sai, khiến ứng dụng của bạn phản hồi không chính xác. Ví dụ, họ có thể gửi các số liệu độ ẩm đất cao liên tục, khiến hệ thống tưới nước của bạn không bao giờ bật và cây của bạn chết vì thiếu nước.
* Người dùng không được phép có thể đọc dữ liệu từ các thiết bị IoT, bao gồm dữ liệu cá nhân hoặc dữ liệu quan trọng đối với doanh nghiệp.
* Hacker có thể gửi lệnh để điều khiển thiết bị theo cách gây hư hại cho thiết bị hoặc phần cứng liên quan.
* Bằng cách kết nối với một thiết bị IoT, hacker có thể sử dụng nó để truy cập các mạng khác và xâm nhập vào các hệ thống riêng tư.
...
* Năm 2018, hacker đã sử dụng một điểm truy cập WiFi mở trên bộ điều nhiệt của bể cá để xâm nhập vào mạng của một sòng bạc và đánh cắp dữ liệu. [The Hacker News - Casino Gets Hacked Through Its Internet-Connected Fish Tank Thermometer](https://thehackernews.com/2018/04/iot-hacking-thermometer.html)
* Năm 2016, botnet Mirai đã thực hiện một cuộc tấn công từ chối dịch vụ (DDoS) vào Dyn, một nhà cung cấp dịch vụ Internet, làm gián đoạn phần lớn Internet. Botnet này sử dụng phần mềm độc hại để kết nối với các thiết bị IoT như DVR và camera sử dụng tên người dùng và mật khẩu mặc định, và từ đó thực hiện cuộc tấn công. [The Guardian - DDoS attack that disrupted internet was largest of its kind in history, experts say](https://www.theguardian.com/technology/2016/oct/26/ddos-attack-dyn-mirai-botnet)
...
* Strava gắn thẻ các vận động viên chạy bộ mà bạn chạy qua và hiển thị tuyến đường của họ, cho phép người lạ thực sự thấy nơi bạn sống. [Kim Komndo - Fitness app could lead a stranger right to your home — change this setting](https://www.komando.com/security-privacy/strava-fitness-app-privacy/755349/).

✅ Nghiên cứu thêm: Tìm kiếm thêm các ví dụ về các vụ hack IoT và vi phạm dữ liệu IoT, đặc biệt là với các vật dụng cá nhân như bàn chải đánh răng hoặc cân kết nối Internet. Hãy suy nghĩ về tác động của những vụ hack này đối với nạn nhân hoặc khách hàng.

> 💁 Bảo mật là một chủ đề rất lớn, và bài học này chỉ đề cập đến một số kiến thức cơ bản về việc kết nối thiết bị của bạn với đám mây. Các chủ đề khác không được đề cập bao gồm giám sát sự thay đổi dữ liệu trong quá trình truyền, hack trực tiếp vào thiết bị, hoặc thay đổi cấu hình thiết bị. Việc hack IoT là một mối đe dọa lớn, các công cụ như [Azure Defender for IoT](https://azure.microsoft.com/services/azure-defender-for-iot/?WT.mc_id=academic-17441-jabenn) đã được phát triển. Những công cụ này tương tự như các công cụ chống virus và bảo mật mà bạn có thể có trên máy tính của mình, nhưng được thiết kế cho các thiết bị IoT nhỏ, công suất thấp.

## Mật mã học

Khi một thiết bị kết nối với dịch vụ IoT, nó sử dụng một ID để xác định chính nó. Vấn đề là ID này có thể bị sao chép - hacker có thể thiết lập một thiết bị độc hại sử dụng cùng ID với thiết bị thật nhưng gửi dữ liệu giả mạo.
...
Cách giải quyết vấn đề này là chuyển đổi dữ liệu được gửi thành một định dạng bị mã hóa, sử dụng một giá trị để mã hóa dữ liệu mà chỉ thiết bị và đám mây biết. Quá trình này được gọi là *mã hóa*, và giá trị được sử dụng để mã hóa dữ liệu được gọi là *khóa mã hóa*.
...
Dịch vụ đám mây sau đó có thể chuyển đổi dữ liệu trở lại định dạng có thể đọc được, sử dụng một quá trình gọi là *giải mã*, sử dụng cùng khóa mã hóa hoặc một *khóa giải mã*. Nếu tin nhắn được mã hóa không thể được giải mã bằng khóa, thiết bị đã bị hack và tin nhắn sẽ bị từ chối.

Kỹ thuật để thực hiện mã hóa và giải mã được gọi là *mật mã học*.

### Mật mã học cổ điển

Các loại mật mã học đầu tiên là các mật mã thay thế, xuất hiện cách đây 3.500 năm. Mật mã thay thế liên quan đến việc thay thế một chữ cái bằng một chữ cái khác. Ví dụ, [mật mã Caesar](https://wikipedia.org/wiki/Caesar_cipher) liên quan đến việc dịch chuyển bảng chữ cái theo một số lượng xác định, chỉ người gửi tin nhắn mã hóa và người nhận dự định biết số lượng chữ cái cần dịch chuyển.

[Mật mã Vigenère](https://wikipedia.org/wiki/Vigenère_cipher) đã phát triển thêm bằng cách sử dụng các từ để mã hóa văn bản, sao cho mỗi chữ cái trong văn bản gốc được dịch chuyển theo một số lượng khác nhau, thay vì luôn dịch chuyển theo cùng một số lượng chữ cái.

Mật mã học đã được sử dụng cho nhiều mục đích khác nhau, chẳng hạn như bảo vệ công thức men gốm ở Mesopotamia cổ đại, viết các ghi chú tình yêu bí mật ở Ấn Độ, hoặc giữ bí mật các câu thần chú ma thuật của Ai Cập cổ đại.

### Mật mã học hiện đại

Mật mã học hiện đại tiên tiến hơn nhiều, khiến việc phá mã khó khăn hơn so với các phương pháp cổ điển. Mật mã học hiện đại sử dụng toán học phức tạp để mã hóa dữ liệu với số lượng khóa khả thi quá lớn để các cuộc tấn công brute force có thể thực hiện được.
...
Đáng tiếc, không phải mọi thứ đều an toàn. Một số thiết bị không có bảo mật, những thiết bị khác được bảo mật bằng các khóa dễ bị phá, hoặc đôi khi tất cả các thiết bị cùng loại sử dụng cùng một khóa. Đã có những trường hợp các thiết bị IoT rất cá nhân đều có cùng mật khẩu để kết nối qua WiFi hoặc Bluetooth. Nếu bạn có thể kết nối với thiết bị của mình, bạn cũng có thể kết nối với thiết bị của người khác. Một khi đã kết nối, bạn có thể truy cập một số dữ liệu rất riêng tư hoặc kiểm soát thiết bị của họ.

> 💁 Mặc dù sự phức tạp của mật mã học hiện đại và các tuyên bố rằng việc phá mã có thể mất hàng tỷ năm, sự phát triển của máy tính lượng tử đã dẫn đến khả năng phá vỡ tất cả các mã hóa hiện tại trong một thời gian rất ngắn!

### Khóa đối xứng và khóa bất đối xứng

Mã hóa có hai loại - đối xứng và bất đối xứng.

**Đối xứng** sử dụng cùng một khóa để mã hóa và giải mã dữ liệu. Cả người gửi và người nhận đều cần biết cùng một khóa. Đây là loại ít an toàn nhất, vì khóa cần được chia sẻ bằng cách nào đó. Để người gửi gửi một tin nhắn mã hóa cho người nhận, người gửi trước tiên có thể phải gửi khóa cho người nhận.

![Mã hóa khóa đối xứng sử dụng cùng một khóa để mã hóa và giải mã tin nhắn](../../../../../translated_images/send-message-symmetric-key.a2e8ad0d495896ffcdf15d25bb4491c695a5cb851457b359fb0f0c89d67707c9.vi.png)

Nếu khóa bị đánh cắp trong quá trình truyền, hoặc người gửi hoặc người nhận bị hack và khóa bị lộ, mã hóa có thể bị phá.

![Mã hóa khóa đối xứng chỉ an toàn nếu hacker không lấy được khóa - nếu có, họ có thể chặn và giải mã tin nhắn](../../../../../translated_images/send-message-symmetric-key-hacker.e7cb53db1707adfb1486a8144060cb76435fe8dbdede8cecc09e7d15b2d9a251.vi.png)

**Bất đối xứng** sử dụng 2 khóa - một khóa mã hóa và một khóa giải mã, được gọi là cặp khóa công khai/riêng tư. Khóa công khai được sử dụng để mã hóa tin nhắn, nhưng không thể được sử dụng để giải mã, khóa riêng tư được sử dụng để giải mã tin nhắn nhưng không thể được sử dụng để mã hóa.
...
Thiết bị IoT có thể được bảo mật bằng mã hóa đối xứng hoặc bất đối xứng. Đối xứng dễ thực hiện hơn, nhưng ít an toàn hơn.
...
Chuỗi kết nối này bao gồm ba phần được phân tách bằng dấu chấm phẩy, với mỗi phần là một khóa và một giá trị:
...
Khi thiết bị lần đầu tiên cố gắng kết nối, nó gửi một token chữ ký truy cập chia sẻ (SAS) bao gồm URL của IoT Hub, một dấu thời gian mà chữ ký truy cập sẽ hết hạn (thường là 1 ngày kể từ thời điểm hiện tại), và một chữ ký. Chữ ký này bao gồm URL và thời gian hết hạn được mã hóa bằng khóa truy cập chia sẻ từ chuỗi kết nối.

IoT Hub giải mã chữ ký này bằng khóa truy cập chia sẻ, và nếu giá trị được giải mã khớp với URL và thời gian hết hạn, thiết bị được phép kết nối. Nó cũng xác minh rằng thời gian hiện tại trước thời gian hết hạn, để ngăn chặn một thiết bị độc hại bắt giữ token SAS của một thiết bị thật và sử dụng nó.

Đây là một cách tinh tế để xác minh rằng người gửi là thiết bị chính xác. Bằng cách gửi một số dữ liệu đã biết ở cả dạng không mã hóa và mã hóa, máy chủ có thể xác minh thiết bị bằng cách đảm bảo khi nó giải mã dữ liệu mã hóa, kết quả khớp với phiên bản không mã hóa đã được gửi. Nếu khớp, thì cả người gửi và người nhận đều có cùng khóa mã hóa đối xứng.
...
Chứng chỉ X.509 là các tài liệu kỹ thuật số chứa phần khóa công khai của cặp khóa công khai/khóa riêng. Chúng thường được cấp bởi một trong số các tổ chức đáng tin cậy gọi là [Certification authorities](https://wikipedia.org/wiki/Certificate_authority) (CAs) và được ký số bởi CA để chỉ ra rằng khóa là hợp lệ và đến từ bạn. Bạn tin tưởng chứng chỉ và rằng khóa công khai là từ người mà chứng chỉ nói rằng nó đến từ, bởi vì bạn tin tưởng CA, tương tự như cách bạn tin tưởng hộ chiếu hoặc giấy phép lái xe vì bạn tin tưởng quốc gia cấp nó. Chứng chỉ có chi phí, vì vậy bạn cũng có thể 'tự ký', tức là tạo một chứng chỉ tự mình ký để sử dụng cho mục đích thử nghiệm.

> 💁 Bạn không bao giờ nên sử dụng chứng chỉ tự ký cho một phiên bản sản xuất.

Các chứng chỉ này có một số trường, bao gồm thông tin về người sở hữu khóa công khai, chi tiết của CA đã cấp chứng chỉ, thời gian hiệu lực và chính khóa công khai. Trước khi sử dụng chứng chỉ, thực hành tốt là xác minh nó bằng cách kiểm tra xem nó đã được ký bởi CA gốc hay chưa.
...
Một lợi thế lớn của việc sử dụng chứng chỉ X.509 là chúng có thể được chia sẻ giữa các thiết bị. Bạn có thể tạo một chứng chỉ, tải nó lên IoT Hub và sử dụng nó cho tất cả các thiết bị của bạn. Mỗi thiết bị sau đó chỉ cần biết khóa riêng để giải mã các tin nhắn nhận được từ IoT Hub.
...
Các bước để tạo chứng chỉ X.509 là:

1. Tạo cặp khóa công khai/khóa riêng. Một trong những thuật toán được sử dụng rộng rãi nhất để tạo cặp khóa công khai/khóa riêng được gọi là [Rivest–Shamir–Adleman](https://wikipedia.org/wiki/RSA_(cryptosystem))(RSA).

1. Gửi khóa công khai cùng với dữ liệu liên quan để ký, bởi CA hoặc tự ký.

Azure CLI có các lệnh để tạo danh tính thiết bị mới trong IoT Hub và tự động tạo cặp khóa công khai/khóa riêng và tạo chứng chỉ tự ký.
...
Làm theo hướng dẫn liên quan để kết nối thiết bị IoT của bạn với đám mây bằng chứng chỉ X.509:
...
Có nhiều cách để tạo, quản lý và xóa các dịch vụ Azure như Resource Groups và IoT Hubs. Một cách là sử dụng [Azure Portal](https://portal.azure.com?WT.mc_id=academic-17441-jabenn) - giao diện web cung cấp GUI để quản lý các dịch vụ Azure của bạn.
...
**Gợi ý** - khi tạo dịch vụ qua cổng thông tin, bạn không cần tạo Resource Group trước, một nhóm có thể được tạo khi bạn tạo dịch vụ. Hãy chắc chắn xóa nó khi bạn hoàn thành!
...
[Xây dựng một thiết bị IoT mới](assignment.md)
