...
![传统开发使用输入和算法生成输出。机器学习使用输入和输出数据训练模型，该模型可以用新输入数据生成新输出](../../../../../translated_images/zh/traditional-vs-ml.5c20c169621fa539.png)
...
![一旦您能识别形状，它们可以以不同的配置组成一艘船或一只猫](../../../../../translated_images/zh/shapes-to-images.1a309f0ea88dd66f.png)
