...
![ایک گراف جو درجہ حرارت بڑھنے کے ساتھ افزائش کی شرح کو بڑھتا ہوا دکھاتا ہے، پھر درجہ حرارت بہت زیادہ ہونے پر کم ہوتا ہے](../../../../../translated_images/ur/plant-growth-temp-graph.c6d69c9478e6ca83.png)
...
> 💁 اگر آپ ورچوئل IoT ڈیوائس استعمال کر رہے ہیں، تو رینڈم چیک باکس منتخب کریں اور ایک رینج سیٹ کریں تاکہ ہر بار ایک ہی درجہ حرارت نہ ملے جب درجہ حرارت کی ویلیو واپس آئے۔
    ![رینڈم چیک باکس منتخب کریں اور ایک رینج سیٹ کریں](../../../../../translated_images/ur/select-the-random-checkbox-and-set-a-range.32cf4bc7c12e797f.png) 
