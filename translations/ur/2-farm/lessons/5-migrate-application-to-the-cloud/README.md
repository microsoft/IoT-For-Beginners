...
![جب ایک ساتھ کئی ایونٹس بھیجے جاتے ہیں، تو سرور لیس سروس ان سب کو ایک ساتھ چلانے کے لیے اسکیل کرتی ہے](../../../../../translated_images/ur/serverless-scaling.f8c769adf0413fd1.png)
...
1. موجودہ فولڈر کو VS Code میں کھولیں، یا تو VS Code کھول کر اس فولڈر کو کھولیں، یا درج ذیل کمانڈ چلائیں:
    ...
    ![نوٹیفکیشن](../../../../../translated_images/ur/vscode-azure-functions-init-notification.bd19b49229963edb.png)
