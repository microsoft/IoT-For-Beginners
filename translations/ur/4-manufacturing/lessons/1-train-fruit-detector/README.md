...
![روایتی ترقی ان پٹ اور الگورتھم لیتی ہے اور آؤٹ پٹ دیتی ہے۔ مشین لرننگ ان پٹ اور آؤٹ پٹ ڈیٹا کا استعمال کرکے ماڈل کو تربیت دیتی ہے، اور یہ ماڈل نئے ان پٹ ڈیٹا کو لے کر نیا آؤٹ پٹ پیدا کر سکتا ہے](../../../../../translated_images/ur/traditional-vs-ml.5c20c169621fa539.png)
...
![ایک بار جب آپ اشکال کو پہچان سکتے ہیں، تو انہیں مختلف ترتیب میں رکھ کر ایک کشتی یا بلی بنائی جا سکتی ہے](../../../../../translated_images/ur/shapes-to-images.1a309f0ea88dd66f.png)
