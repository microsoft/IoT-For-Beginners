...
![ریلیشنل ڈیٹا بیس جس میں یوزر ٹیبل کا ID پرچیزز ٹیبل کے یوزر ID کالم سے جڑا ہوا ہے، اور پروڈکٹس ٹیبل کا ID پرچیزز ٹیبل کے پروڈکٹ ID سے جڑا ہوا ہے](../../../../../translated_images/ur/sql-database.be160f12bfccefd3.png)
...
![IoT ڈیوائس سے GPS ٹیلیمیٹری کو IoT Hub، پھر Azure Functions کے ذریعے ایونٹ ہب ٹرگر، اور پھر blob اسٹوریج میں محفوظ کرنا](../../../../../translated_images/ur/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
