...
1. **ریپوزٹری کو فورک کریں**: کلک کریں [![GitHub forks](https://img.shields.io/github/forks/microsoft/IoT-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/IoT-For-Beginners/fork)
...
![ایک روڈ میپ جو 24 اسباق کا احاطہ کرتا ہے جن میں تعارف، کاشتکاری، نقل و حمل، پراسیسنگ، ریٹیل اور کھانا پکانا شامل ہیں](../../translated_images/ur/Roadmap.bb1dec285dda0eda.webp)
