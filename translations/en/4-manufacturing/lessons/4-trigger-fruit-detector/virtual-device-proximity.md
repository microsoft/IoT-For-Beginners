...
1. Create a distance sensor:
    ...
    ![The distance sensor settings](../../../../../translated_images/en/counterfit-create-distance-sensor.967c9fb98f27888d.webp)

    The distance sensor will be created and appear in the sensors list.

    ![The distance sensor created](../../../../../translated_images/en/counterfit-distance-sensor.079eefeeea0b68af.webp)
