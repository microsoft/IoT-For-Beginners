...
1. Create a light sensor:
    ...
    ![The light sensor settings](../../../../../translated_images/en/counterfit-create-light-sensor.9f36a5e0d4458d8d.webp)

    The light sensor will be created and displayed in the sensors list.

    ![The light sensor created](../../../../../translated_images/en/counterfit-light-sensor.5d0f5584df56b90f.webp)
