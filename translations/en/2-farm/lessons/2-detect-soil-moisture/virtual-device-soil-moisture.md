...
1. Create a soil moisture sensor:
    ...
    ![The soil moisture sensor settings](../../../../../translated_images/en/counterfit-create-soil-moisture-sensor.35266135a5e0ae68.webp)

    The soil moisture sensor will be created and appear in the sensors list.

    ![The soil moisture sensor created](../../../../../translated_images/en/counterfit-soil-moisture-sensor.81742b2de0e9de60.webp)
