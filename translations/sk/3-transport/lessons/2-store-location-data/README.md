...
![Relačná databáza s ID tabuľky používateľov, ktoré sa vzťahuje na stĺpec ID používateľa tabuľky nákupov, a ID tabuľky produktov, ktoré sa vzťahuje na stĺpec ID produktu tabuľky nákupov](../../../../../translated_images/sk/sql-database.be160f12bfccefd3.png)
...
![Odosielanie GPS telemetrie z IoT zariadenia do IoT Hubu, potom do Azure Functions cez spúšťač udalostí Event Hub, a následne ukladanie do blob úložiska](../../../../../translated_images/sk/save-telemetry-to-storage-from-functions.ed3b1820980097f1.png)
