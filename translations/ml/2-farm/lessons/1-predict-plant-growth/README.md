...
![ഈ പാഠത്തിന്റെ സ്കെച്ച്നോട്ട് അവലോകനം](../../../../../translated_images/lesson-5.42b234299279d263.ml.jpg)
...
![താപനില ഉയരുന്നത് കൊണ്ട് വളർച്ച വേഗമേറിയും, പിന്നീട് താപനില ഒറ്റപ്പെടുമ്പോൾ കുറയുന്നത് കാണിക്കുന്ന ഗ്രാഫ്](../../../../../translated_images/plant-growth-temp-graph.c6d69c9478e6ca83.ml.png)
...
![GDD = T max + T min 2 യിലൂടെ ഭാഗിച്ചിട്ട് അതിൽ നിന്ന് T base കുറയ്ക്കുക](../../../../../translated_images/gdd-calculation.79b3660f9c5757aa.ml.png)
...
![GDD = 16 + 12 2 യിലൂടെ വിഭജിക്കുക, എല്ലാം T base 10 കുറച്ച് 4 കിട്ടുന്നു](../../../../../translated_images/gdd-calculation-corn.64a58b7a7afcd0df.ml.png)
...
![ടെലിമെട്രി ഡാറ്റ ഒരു സെർവറിലേക്ക് അയച്ചുയര്‍ത്തിയ ശേഷം ഡാറ്റാബേസ് ഫയലായി സൂക്ഷിക്കുന്നു](../../../../../translated_images/save-telemetry-database.ddc9c6bea0c5ba39.ml.png)
...
1. ഡാറ്റ ശേഖരിക്കാൻ കുറച്ച് സമയത്തേക്ക് ഈ കോഡ് ഓടിക്കുക. GDD കണക്കാക്കാൻ ആവശ്യമായ ഡാറ്റ സമ്പാദിക്കാൻ Ideally ഒരു പൂർണ്ണ ദിവസം ഈ കോഡ് ഓടിക്കണം.
    ...
    ![random ചോർണ്ണിടത്തരൻ തിരഞ്ഞെടുക്കുക, പരിധി സജ്ജീകരിക്കുക](../../../../../translated_images/select-the-random-checkbox-and-set-a-range.32cf4bc7c12e797f.ml.png) 
...
![GDD = 25 + 12 divided by 2, then subtract 10 from the result giving 8.5](../../../../../translated_images/gdd-calculation-strawberries.59f57db94b22adb8.ml.png)
