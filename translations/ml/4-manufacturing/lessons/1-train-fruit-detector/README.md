...
![ഈ പാഠത്തിന്റെ സ്കെച്ച്നോട്ട് അവലോകനം](../../../../../translated_images/ml/lesson-15.843d21afdc6fb2bb.webp)
...
![ഒരു ചുവപ്പ് തക്കാളി തിരിച്ചറിയുമ്പഴെ അത് തുടരുന്നു. പച്ച തക്കാളി തിരിച്ചറിയുമ്പോൾ അത് ലെവറിലൂടെ കളയുന്നു](../../../../../translated_images/ml/optical-tomato-sorting.61aa134bdda4e5b1.webp)
...
![പരമ്പരാഗത വികസനം ഇൻപുട്ടും ആൽഗോരിതവും ഉപയോഗിക്കുന്നു ഫലം നൽകാനും, മെഷീൻ ലേണിംഗ് ഇൻപുട്ടും ഇൻപുട്ടും ഉപയോഗിച്ച് മോഡൽ പരിശീലിപ്പിക്കുകയും പുതിയ ഇൻപുട്ടിൽ പുതിയ ഫലം നൽകുകയും ചെയ്യുന്നു](../../../../../translated_images/ml/traditional-vs-ml.5c20c169621fa539.webp)
...
![രണ്ട് വാഴപ്പഴങ്ങൾ, ഒരു പാകം പൂർത്തിയായത് 99.7% പാകം, 0.3% പാകം അല്ലെങ്കിൽ, മറ്റുള്ളത് 1.4% പാകം, 98.6% പാകം അല്ലെങ്കില്‍ എന്നു പ്രവചിക്കുന്നു](../../../../../translated_images/ml/bananas-ripe-vs-unripe-predictions.8d0e2034014aa50e.webp)
...
![രൂപങ്ങൾ തിരിച്ചറിയുമ്പോൾ അവയെ ബോട്ട് അല്ലെങ്കിൽ പൂച്ച ആക്കാനുള്ള വ്യത്യസ്ത രൂപരേഖകളിലേക്ക് മാറ്റാം](../../../../../translated_images/ml/shapes-to-images.1a309f0ea88dd66f.webp)
...
![Azure Custom Vision ലോഗോ](../../../../../translated_images/ml/custom-vision-logo.d3d4e7c8a87ec9da.webp)
...
1. [Microsoft ഡോക്സ്](https://docs.microsoft.com/azure/cognitive-services/custom-vision-service/getting-started-build-a-classifier?WT.mc_id=academic-17441-jabenn#create-a-new-project) ൽ നൽകിയ *create a new Project* വിഭാഗം പിന്തുടർന്ന് ഒരു പുതിയ Custom Vision പ്രോജക്റ്റ് സൃഷ്ടിക്കുക. UI മാറാം, എപ്പോഴും ഈ ഡോക്യുമെന്റേഷൻ ഏറ്റവും പുതിയതാണ്.
    ...
    ![Custom Vision പ്രോജക്റ്റ് സജ്ജീകരണങ്ങൾ, നാമം fruit-quality-detector സെറ്റ് ചെയ്തതിനായി, വിവരണം ഇല്ല, റിസോഴ്‌സ് fruit-quality-detector-training, പ്രോജക്റ്റ് ടൈപ്പ് classification, ക്ലാസിഫിക്കേഷൻ ടൈപ്പ് multi class, ഡൊമെയ്ൻ food](../../../../../translated_images/ml/custom-vision-create-project.cf46325b92d8b131.webp)
...
1. നിങ്ങളുടെ ക്ലാസിഫയറിനു ചിത്രംകൾ ശേഖരിക്കുക. ക്ലാസിഫയറിന് പരിശീലനത്തിനായി ഓരോ ലേബലിനും കുറഞ്ഞത് 5 ചിത്രങ്ങൾ ആവശ്യമുള്ളതാണ്, പക്ഷേ കൂടുതൽ ഉത്തമമാണ്. കൂടാതെ പരീക്ഷണത്തിന് ചിത്രങ്ങൾ കുറച്ച് വേണം. ഈ ചിത്രങ്ങൾ ഒരേ വസ്തുവിന്റെ വ്യത്യസ്ത ദൃശ്യരൂപങ്ങളാകണം. ഉദാഹരണത്തിന്:
    ...
    * 2 പകഫലമായ മർക്കളുകൾ ഉപയോഗിച്ച്, ഓരോതിന്റെയും പല വ്യത്യസ്ത കോണുകളിൽ നിന്നുള്ള ചിത്രങ്ങൾ എടുക്കുക, കുറഞ്ഞത് 7 ചിത്രം (5 പരിശീലനത്തിനും 2 പരീക്ഷണത്തിനും), എന്നിരുന്നാലും കൂടുതൽ വാങ്ങാനാണ് ഉദ്ദേശം.
        ...
        ![Photos of 2 different bananas](../../../../../translated_images/ml/banana-training-images.530eb203346d73bc.webp)
...
1. നിങ്ങളുടെ പരിശീലന ചിത്രങ്ങൾ അപ്‌ലോഡ് ചെയ്യാൻ Microsoft ഡോക്യുമെന്റിലുള്ള [ബിൽഡ് എ ക്ലാസിഫയർ ക്വിക്ക്സ്റ്റാർട്ട് വിഭാഗത്തിലിലെ അപ്‌ലോഡ് ആൻഡ് ടാഗ് ഇമേജസ് വിഭാഗം](https://docs.microsoft.com/azure/cognitive-services/custom-vision-service/getting-started-build-a-classifier?WT.mc_id=academic-17441-jabenn#upload-and-tag-images) പിന്തുടരുക. പകഫല പഴം `ripe` എന്നാണ് ടാഗ് ചെയ്യുക, പകവഴിതുള്ള പഴം `unripe`.
    ...
    ![The upload dialogs showing the upload of ripe and unripe banana pictures](../../../../../translated_images/ml/image-upload-bananas.0751639f3815e0ec.webp)
...
1. Microsoft ഡോക്യൂമെന്റിലെ [ടെസ്റ്റ് യോർ മodel വിഭാഗം](https://docs.microsoft.com/azure/cognitive-services/custom-vision-service/test-your-model?WT.mc_id=academic-17441-jabenn#test-your-model) പിന്തുടരുക നിങ്ങളുടെ ക്ലാസിഫയർ പരീക്ഷിക്കാൻ. പരിശീലനത്തിന് ഉപയോഗിച്ച ചിത്രങ്ങളിൽ അല്ല, അതിന്റെ പകരം നിങ്ങൾ മുൻപായി സൃഷ്ടിച്ച പരീക്ഷണ ചിത്രങ്ങൾ ഉപയോഗിക്കുക.
    ...
    ![A unripe banana predicted as unripe with a 98.9% probability, ripe with a 1.1% probability](../../../../../translated_images/ml/banana-unripe-quick-test-prediction.dae9b5e1c4ef7c64.webp)
